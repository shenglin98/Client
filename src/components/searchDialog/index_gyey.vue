    ...
    <div class="search_form">
      ...
      >
        ...
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item size="mini" label="开单医生">
              <el-select
                size="mini"
                @change="handleSearch"
        ...
        <el-row>
          <el-col :span="6">
            <el-form-item size="mini" label="价格" class="df_form">
              <el-input
            ...
            <el-form-item size="mini" label="类型">
              <el-button-group>
                <el-button
                  ...
                  type="primary"
                  plain
                  @click="(searchForm.persontype = ''), handleSearch()"
                  >全部</el-button
                >
                <el-button
                  size="mini"
                  type="primary"
                  plain
                  @click="(searchForm.persontype = '0'), handleSearch()"
                  >个检</el-button
                >
                <el-button
                  size="mini"
                  type="primary"
                  plain
                  @click="(searchForm.persontype = '1'), handleSearch()"
                  >团检</el-button
                >
              </el-button-group>
            </el-form-item>
