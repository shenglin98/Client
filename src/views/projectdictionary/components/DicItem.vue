<template>
  <div class="dic_item">
    <div class="head_box">
      ...
      <div class="btn_group">
        <el-button type="warning" size="mini" @click="handleClosePage"
          >关闭</el-button
        >
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item size="small" label="对比标志">
            <el-select
              v-model="form.contrastflag"
              clearable
              filterable
              placeholder="请选择"
            >
              <el-option
                v-for="(item, index) in contrastFlagItem"
                :key="index"
                :label="item.name"
                :value="item.code"
              ></el-option>
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item size="small" label="关键词输入方式">
            ...
            >
              <el-option
                v-for="(item, index) in keyTypeItem"
                :key="index"
                :label="item.name"
                :value="item.code"
              ></el-option>
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item size="small" prop="showtype" label="显示方式">
            ...
            >
              <el-option
                v-for="(item, index) in showTypeItem"
                :key="index"
                :label="item.name"
                :value="item.code"
              ></el-option>
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item size="small" label="重要指标标志">
            <el-select
              v-model="form.importantflag"
              clearable
              filterable
              placeholder="请选择"
            >
              <el-option
                v-for="(item, index) in importantFlagItem"
                :key="index"
                :label="item.name"
                :value="item.code"
              ></el-option>
