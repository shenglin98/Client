    ...
    <div class="app-container flex-item">
      <div class="bg-white fh">
        ...
        >
          ...
          <el-table-column class-name="status-col" :label="'说明'" width="100">
            <template slot-scope="scope">
      ...
      >
        <selectUsersCom
          ...
          :userNames="
            roleUsers.rowIndex > -1 &&
            roleUsers.list[roleUsers.rowIndex]
              .map((u) => u.name || u.account)
              .join(',')
          "
        >
        </selectUsersCom>
