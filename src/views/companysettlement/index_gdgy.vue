<template>
  <div class="company_settlement">
          ...
          <div class="head_content">
            <el-form :inline="true" :model="formInline" class="demo-form-inline" height="30" style="height: 40px">
              ...
              <el-form-item label="单位名称">
                <el-select style="width: 300px" size="mini" v-model="company" clearable filterable remote reserve-keyword :remote-method="handleRemoteMethod" :loading="selectLoading" @clear="handleRemoteMethod" @change="handleSelectCompany">
              ...
              <el-form-item label="批次">
                <el-select v-model="batch" size="mini">
                  <el-option v-for="(item, index) in batchitems" clearable :key="index" :label="item.name" :value="item.code"></el-option>
                </el-select>
              </el-form-item>
            </el-form>
          </div>
    ...
    <!-- 新增或编辑 -->
    <AddOrEdit v-else :addOrEdit="pageFlag" @close="handleCloseAddOrEdit" :pSetid="pSetid" />
  </div>
</template>
<script>
