    ...
    <div class="subject">
      ...
      <div class="s_right">
        ...
        <div class="mode_message">
          ...
          <div class="message_itme">
            <div class="m_title">单位名称</div>
            <div class="m_value">
              <el-input
                size="mini"
                v-model="companynamesettlement"
                clearable
                :disabled="pageFlag == 'edit'"
              ></el-input>
            </div>
          ...
          <div class="message_itme">
            <div class="m_title">健康卡号</div>
            <div class="m_value">{{ healthcard }}</div>
          </div>
        </div>
        <!-- 结算说明 -->
  ...
  methods: {
    ...
    handleSetSettlementCreate() {
      ...
      let settlementitem = {
        ...
        companynamesettlement: this.companynamesettlement,
    ...
    handleSetSettlDetail() {
      setSettlDetail({ setid: this.setid }).then((res) => {
        ...
        this.companynamesettlement = settlementitem.companynamesettlement;
        this.invoiceno = settlementitem.invoiceNo;
        this.healthcard = settlementitem.healthcard;
