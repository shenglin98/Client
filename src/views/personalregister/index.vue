      ...
      >
        <div class="table_box">
          <EasyTable
            ...
            @selected-change="handleSelectIntellect"
            :border="false"
            :header-cell-style="handleReturnStyle"
            :row-class-name="handleTableRowClassName"
            :row-style="{ height: '32px' }"
...
export default {
  ...
  data() {
    ...
    return {
      ...
      healthcardcode: "healthcard", //选中健康卡/身份证对象编码
    ...
    window.onkeyup = function (e) {
      if (e.keyCode === 13) {
        ...
        if ($(":focus")[0] && $(":focus")[0].className === "el-input__inner") {
          ...
          console.log($(".el-input__inner").eq(index + 1)[0]);
          $(".el-input__inner")
            .eq(index + 1)
            .focus();
        }
  ...
  methods: {
    ...
    handleConfirmDiscount() {
      ...
      setDiscount({
        ...
        if (res.code == 200) {
          this.$message.success(res.message);
          this.groupTableData.forEach((item) => {
            item.discount = this.discountValue / 100;
          });
    ...
    hadnleSubmit() {
      ...
      if (
        ...
        let showFlag = false;
        if (+idcardCheck % 2 == 0) {
          this.personalForm.sex !== 2 ? (showFlag = true) : (showFlag = false);
        } else {
          this.personalForm.sex !== 1 ? (showFlag = true) : (showFlag = false);
        }
        if (showFlag) {
    ...
    handleProjectSubmit(data) {
      if (this.pageState === "edit") {
        ...
        setSubmit(this.personalForm).then((res) => {
          this.$message("操作成功!");
          this.groupPriceTotal = 0;
          this.groupPriceEnd = 0;
          // 选中新增数据
    ...
    handleGetPersonalDetail(regid) {
      ...
      getPersonalDetail({
        ...
        console.log(this.isGuideSingle, "this.isGuideSingle");
    ...
    // 打印申请单
    handlePrintApply() {
      console.log(this.choosePeople, "this.choosePeople-申请单");
      if (!this.choosePeople) {
