    ...
    <div class="pageReg" v-if="!showQuestionnaire && !showHealthView">
            ...
            <div class="content_left" :class="[message != 'basic' ? 'height_h' : '']">
              ...
              <div class="basicInfo">
                <div class="message">
                  ...
                  <div class="card_operations" v-if="message == 'basic'">
                    ...
                    <el-button type="primary" size="mini" :disabled="formFlag" plain @click="
                        pageState == 'add' ? handleCardReading() : handleCardReadingEdit()
                                  ...
                                  <div class="two_options" v-for="(value, index) in item.optionitems" :key="index">
                                    <span v-if="value.inputtype === -1">
                                      ...
                                      <template v-for="(val, index) in value.content
                                          .split('|X|')
                                          .filter((v) => v)">
                                        <myInput v-if="showMyInput" :suffix="val" :disabled="item.editstatus == 1" :width="value.contentlength" :count="
                                    ...
                                    <el-radio-group v-model="item.selectvalue" :disabled="item.editstatus == 1" @change="isUpdateQuestionnaire = true">
                                      <el-radio v-if="[0, 3].indexOf(value.inputtype) !== -1" :label="value.selectvalue" style="margin-right: 5px">
                                        <span v-if="value.content.indexOf('|X|') !== -1">
                                          <template v-for="(val, index) in value.content.split(
                                            ...
                                            <myInput :content="val" :disabled="val.editstatus == 1" :width="value.contentlength" :draggable="
                                    ...
                                    <el-checkbox v-if="[2, 4].indexOf(value.inputtype) !== -1" v-model="value.flag" :label="value.content" :true-label="1" :false-label="0" @change="isUpdateQuestionnaire = true">{{ value.content }}</el-checkbox>
                                  </div>
                                  <i class="el-icon-delete-solid" style="cursor: pointer" v-if="
                                      item.optionitems.length > 0 &&
                                      [0, 3].indexOf(item.optionitems[0].inputtype) !== -1
                                    " @click="handleClickTwoOptionsSwitch(item)"></i>
                                  <el-input v-if="[1, 3, 4].indexOf(item.inputtype) !== -1" size="mini" :disabled="item.editstatus == 1" v-model="item.remark" @focus="isUpdateQuestionnaire = true" placeholder="请输入" :style="{ width: item.contentlength + 'px' }"></el-input>
                                </div>
                                ...
                                <div class="three_topic" v-for="item in item.questionnaireitems" :key="item.itemcode">
                                  <span v-if="item.itemname.indexOf('|X|') !== -1">
                                    <template v-for="(val, index) in item.itemname.split(',')">
                                      <myInput :content="val" :width="item.contentlength" :count="item.itemname.split(',').length" :value.sync="item.remark" :index="index" :key="val" />
                                    </template>
                                  </span>
                                  <span v-else>
                                    {{ item.itemname }}
                                  ...
                                  <div class="three_content">
                                    ...
                                    <div class="three_options" v-for="(item6, index) in item.optionitems" :key="index">
                                      <span v-if="[-1].indexOf(item6.inputtype) !== -1">
                                        <span v-if="item6.content.indexOf('|X|') !== -1">
                                          <template v-for="(val, index) in item6.content.split(
                                              ','
                                            )">
                                            <myInput :content="val" :width="item6.contentlength" :count="item6.content.split(',').length" :value.sync="item6.remark" :index="index" :key="val" />
                                          </template>
                                        </span>
                                      </span>
                                      <el-radio v-model="item.selectvalue" v-if="[0, 3].indexOf(item6.inputtype) !== -1" :label="item6.content" style="margin-right: 5px" @change="isUpdateQuestionnaire = true">
                                        <span v-if="item6.content.indexOf('|X|') !== -1">
                                          <template v-for="(val, index) in item6.content.split(
                                              ','
                                            )">
                                      ...
                                      <el-checkbox :label="item6.hoyname" v-if="[2, 4].indexOf(item6.inputtype) !== -1" v-model="item6.flag" :true-label="1" :false-label="0" @change="isUpdateQuestionnaire = true">
                                        <span v-if="item6.content.indexOf('|X|') !== -1">
                                          <template v-for="(val, index) in item6.content.split(
                                              ','
                                            )">
                                            <myInput :content="val" :width="item6.contentlength" :disabled="item6.flag == 0 ? true : false" :count="item6.content.split(',').length" :value.sync="item6.remark" :index="index" :key="val" />
                                          </template>
                                        </span>
                                        <span v-else>
                                          {{ item6.content }}
                                      ...
                                      <el-input v-if="[1].indexOf(item6.inputtype) !== -1" size="mini" v-model="item6.remark" style="width: 160px" @focus="isUpdateQuestionnaire = true"></el-input>
                                      <el-input v-if="[3, 4].indexOf(item6.inputtype) !== -1" :disabled="item6.flag == 0" size="mini" v-model="item6.remark" style="width: 160px" @focus="isUpdateQuestionnaire = true"></el-input>
                                    </div>
                                  </div>
                                  <i class="el-icon-delete-solid" style="cursor: pointer" v-if="
                                      item.optionitems.length > 0 &&
                ...
                <div v-if="message == 'basic'" class="personal_info">
                  ...
                  <div class="info_body">
                    <div class="form_box">
                      <el-form ref="formpage" :disabled="formFlag" :model="personalForm" :rules="rulePersonalForm" label-width="80px">
                        <el-row>
                          <el-col :span="6">
                          ...
                          <el-col :span="6">
                            <el-form-item size="mini" label="性别" class="mess_select" :rules="[{ required: !personalForm.sex }]">
                        ...
                        <el-row>
                          ...
                          <el-col :span="6">
                            <el-form-item size="mini" class="mess_select" label="证件类型">
                          ...
                          <el-col :span="6">
                            <el-form-item size="mini" label="证件号" prop="idcard">
                        ...
                        <el-row>
                          <el-col :span="6">
                            <el-form-item size="mini" class="mess_select" label="体检类型">
                        ...
                        <el-row>
                          <el-col :span="6">
                            <el-form-item size="mini" class="mess_select" label="领取方式">
                        ...
                        <el-row>
                          <el-col :span="6">
                            <el-form-item size="mini" label="派单方式">
                              <el-select v-model="personalForm.sendtype" placeholder="">
                          ...
                          <el-col :span="6">
                            <el-form-item size="mini" label="在职情况">
                              <el-input v-model="personalForm.jobin"></el-input>
                          ...
                          <el-col :span="6">
                            <el-form-item size="mini" label="任职情况">
                              <el-input v-model="personalForm.positionin"></el-input>
                ...
                <div v-if="message == 'other'" class="other_info">
                  ...
                  <el-form ref="form" class="other_info_form" :disabled="formFlag" :model="personalForm" label-width="90px">
                    ...
                    <el-row>
                      <el-col :span="6">
                        <el-form-item size="mini" label="医疗证号">
                ...
                <div class="team_inspect" style="width: 100%">
                  <div style="width: 100%">
                    <div class="message-title" style="width: 100%">
                      ...
                      <el-checkbox v-model="isLearnChecked" @change="handleChangeIsLearnChecked"></el-checkbox>
                      <div class="message_content" style="width: 100%">
                        <div class="laoganmask" v-if="groupdis && personalForm.companytype == 10107" @click="handleTipsLaoGan"></div>
                  ...
                  <div class="checkup_body">
                    <div class="state_group">
                      <div class="state_item">
                        ...
                        <div class="state1">
                          {{ this.personalForm.nodedflagcount || groupTableData.length }}
                        </div>
                      </div>
                      <div class="state_item">
                        ...
                        <div class="state2">
                          {{
                            (this.personalForm.regid && this.personalForm.price) ||
                      ...
                      <div class="state_item">
                        ...
                        <div class="state3" v-if="
                            this.personalForm.regid &&
                            (personalForm.discountprice != '' ||
                              personalForm.discountprice != null)
                          ">
                          {{ personalForm.discountprice }}
                        </div>
                        <div class="state3" v-else>
                      ...
                      <div class="state_item">
                        ...
                        <div class="state4">
                          {{
                            (this.personalForm.regid && this.personalForm.actPrice) ||
                ...
                <div class="checkup_btn-in">
                  <div class="checkup_btn">
                    ...
                    <!-- <el-button
                        ...
                        >复制登记</el-button
                      > -->
                    <el-button class="checkin" type="primary" size="mini" plain style="height: 28px" @click="(setmealRadio = ''), handleGetPersonalRegisterList()">刷新</el-button>
                  </div>
                  <!-- 登记人员列表 -->
      ...
      <el-dialog class="dialog-mini charge_details" width="74%" top="4%" :close-on-click-modal="false" title="收费列表" :visible.sync="showChargeDetails" @close="handleCloseChargeDetails">
        <div style="display: flex; align-items: center">
          项目总数：{{ chargeDataList.length }} 未交费项目：{{ noCharge.length }}个
      ...
      <!-- 检索组件 -->
      <SearchDialog v-if="showSearch" :showSearch="showSearch" :cardReaderFlag="cardReaderFlag" @close="handleCloseSearch" @submit="handleSearchSubmit" @copy="handleSearchCopy" />
      <!-- 打印申请单 -->
...
export default {
  ...
  data() {
    ...
    return {
      ...
      isQuestionnaireSave: false, // 是否问卷保存
      isUpdateQuestionnaire: false, // 保存前问卷是否填写
      meccode: "",
      officerFlag: false,
      showCollect: false,
      collectRemark: "",
  ...
  methods: {
    ...
    // 问卷单选点击触发
    handleClickTwoOptionsSwitch(item) {
      if (item.selectvalue != "") {
      ...
      this.$confirm("此操作将删除当前照片, 是否继续?", "提示", {
        ...
        .then(() => {
          ...
          this.selectPerviewUrl.forEach((item) => {
            data.push({ regid: this.setmealRadio, fileid: item.fileid });
          });
          data.length > 0 &&
    ...
    handleSaveArchivesImages(base64) {
      ...
      ImportImage({ imagebaseStr: base64 }).then((res) => {
        ...
        // 拿到服务器图片id,再存到当前用户
        SaveArchivesImages([
          { regid: this.setmealRadio, fileid: res.result.id },
        ]).then((res) => {
    ...
    // 获取照片列表数据
    getphotographList() {
      ArchivesImages({ regid: this.setmealRadio }).then((res) => {
    ...
    handleChangeIsLearnChecked(value) {},
    // 指定区域拖动  这里是关键
    ...
    handleSaveQuestionnaire() {
      if (this.choosePeople && this.choosePeople.regid) {
        ...
        this.isQuestionnaireSave = true;
        this.handleLogicSaveSubmit();
      }
    },
    // 病史采集保存回调
    ...
    handleMedicalHistory() {
      let data = {
        regid: (this.choosePeople && this.choosePeople.regid) || "",
      };
    ...
    handleCopyCheckIn(flag) {
      if (!this.choosePeople && !this.personalForm.regid) {
      ...
      if (flag === "projectDia") {
        CopyCombine({ regid: this.personalForm.regid }).then((res) => {
          if (!res.result) return;
          this.groupTableData = res.result.combineitems.filter((k) => {
            return k.combineStatus == 0;
          });
          let tips = res.result.combineitems.filter((k) => {
            return k.combineStatus == 1;
          });
          if (tips.length > 0) {
            let temp = tips.map((k) => k.combinename);
            this.$confirm(`${temp.join("、")}已停用!`, "提示", {
              confirmButtonText: "确定",
              showCancelButton: false,
              showClose: false,
              closeOnClickModal: false,
    ...
    hadnleSubmit() {
      ...
      if (
        this.personalForm.telephone &&
        this.personalForm.telephone.length > 11
      ) {
        this.$message.warning("联系方式异常,请检查输入是否正确!");
        return false;
      }
      // 去除收尾空格 - 姓名去除空格证件类型必须为身份证-01
      if (this.personalForm.idtype == "01") {
        this.personalForm.name = this.personalForm.name.replace(/\s/g, "");
      }
      this.personalForm.idcard = this.personalForm.idcard.replace(/\s/g, "");
      this.personalForm.telephone = this.personalForm.telephone.replace(
        /\s/g,
        ""
      );
      ...
      if (
        ...
        this.meccode == "0" &&
        !this.personalForm.companycode &&
        !this.isUpdateQuestionnaire
      ) {
        this.$confirm("当前未填写健康问卷, 请先填写健康问卷?", "提示", {
          confirmButtonText: "去填写",
          ...
          .then(() => {
            // this.message = 1006;
            this.handleRadioButton(1006);
          })
          .catch(() => {
            this.hadnleSubmitTJ1();
          });
      } else {
        this.hadnleSubmitTJ1();
      }
          ...
          .catch(() => {
            ...
            setSubmit(this.personalForm)
              .then((res) => {
                ...
                if (this.isLearnChecked) {
                  localStorage.setItem(
                    "isLearnCheckedObj",
                    JSON.stringify({
                      isChcked: this.isLearnChecked,
                      companycode: this.personalForm.companycode,
                  ...
                  localStorage.removeItem("isLearnCheckedObj");
                }
                if (this.isQuestionnaireSave) {
                  SaveQuestionnaire({
                    regid: resRegid,
                    questionnaireitems: this.questionnairelist,
                  }).then((res) => {
                  ...
                  this.isQuestionnaireSave = false;
                }
              })
              .catch((err) => {
                this.loadingBtn = false;
    ...
    handleCreate() {
      ...
      this.isUpdateQuestionnaire = false; // 新增重置选中人员
      localStorage.removeItem("groupTableData");
      this.avatarImg = require("./images/lin.jpg");
      // 聚焦身份证框
      this.$nextTick(() => {
    ...
    handleGetDetail() {
      getPersonalDetail().then((res) => {
        ...
        // ------
        let isLearnCheckedObj =
          JSON.parse(localStorage.getItem("isLearnCheckedObj")) || "";
        if (isLearnCheckedObj) {
          this.isLearnChecked = isLearnCheckedObj.isChcked;
          this.personalForm.companycode = isLearnCheckedObj.companycode;
          this.personalForm.companyname = isLearnCheckedObj.companyname;
          this.personalForm.batch = isLearnCheckedObj.batch;
        }
        getSysConfigInfo({
    ...
    handleEditPage() {
      ...
      this.groupdis = false; // 解除团检表单限制可编辑
      // 特殊老干判断 10107
      if (this.choosePeople.companytype == 10107) {
        this.groupdis = true;
      }
    },
    // 点击删除个人列表数据
    ...
    handleSearchCopy(data) {
      ...
      getPersonalDetail({
        ...
        this.handleCopyCheckIn(data.flag);
      });
    },
    // 检索组件提交回调
    ...
    handdleMsg(msg) {
      ...
      console.log(that.$global2.ws2.readyState);
    ...
    handlePrintBarCode() {
      ...
      that.handdleMsg(
        that.jsonSf({
          BusinessType: "PrintBarcodeForThird",
          Token: getToken(),
          Data: {
            regid: this.choosePeople.regid,
            month: 1,
