                ...
                <div class="message">
                  ...
                  <div class="card_operations" v-if="message == 'basic'">
                    ...
                    <input
                      ...
                      ref="read_healthcard"
                      v-if="healthcardcode == 'healthcard'"
  ...
  methods: {
    ...
    handleHealthCard() {
      ...
      getPatientInfo({
        ...
        .then((res) => {
          ...
          if (res.result.length == 0) return;
          console.log("进来了吗", 1111);
          console.log("==", res.result.length == 1);
          console.log(res.result.length == 1);
          console.log(res.result.length == 1 && res.result[0].hiscode);
    ...
    handlePrintGuideSingle() {
      ...
      if (d.$el.innerText == "指引单打印") {
        ...
        printBase64(data).then((res) => {
          this.choosePeople.checktype == 7 && this.handlePrintGuideSingleAdult();
          this.lodop = getLodop();
          let printname = ``;
          if (res.data[0].printname == "") {
            printname = this.lodop.GET_PRINTER_NAME(-1);
