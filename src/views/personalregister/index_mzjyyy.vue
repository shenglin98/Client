<template>
  <div class="personal_register">
    <div class="pageReg" v-if="!showQuestionnaire && !showHealthView">
              ...
              <div class="basicInfo">
                ...
                >
                  ...
                  >
                    <!-- 病史采集 -->
                    <div
                      v-if="item.titletype == 'MedicalHistory' ? true : false"
                    >
                      <div
                        class="card"
                    ...
                    <!-- 问卷 -->
                    <div
                      v-if="item.titletype == 'Questionnaire' ? true : false"
                    >
                          ...
                          <el-col :span="6">
                            <el-form-item size="mini" label="身份证">
                              ...
                              <input
                                ...
                                @keyup.enter="handleChangeIdcard"
                              />
                            </el-form-item>
                          </el-col>
                        </el-row>
                          ...
                          <el-col :span="6">
                            <el-form-item size="mini" label="标准金额">
                              <el-input
                                v-if="pageState == 'add'"
                                disabled
                                v-model="checkGroup.value"
                              ></el-input>
                              <el-input
                                v-else
                                disabled
                                v-model="personalForm.quota"
                              ></el-input>
                            </el-form-item>
                          </el-col>
                          <el-col :span="6">
                    ...
                    <el-row>
                      <el-col :span="8">
                        <el-form-item size="mini" label="籍贯">
                          <el-input
                            v-model="personalForm.nativeplace"
                          ></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="8">
                    ...
                    <el-row>
                      ...
                      <el-col :span="8">
                        <el-form-item size="mini" label="业务来源">
                          <el-input
                            v-model="personalForm.businesssource"
                          ></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                    <el-row>
                      <el-col :span="12">
                        <el-form-item size="mini" label="特殊说明">
                          <el-input
                            v-model="personalForm.remindcontent"
                          ></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="6">
                    ...
                    <el-row>
                      <el-col :span="8">
                        <el-form-item size="mini" label="体检人姓名">
                          <el-input
                            v-model="personalForm.actualname"
                          ></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="8">
                    ...
                    <el-row>
                      ...
                      <el-col :span="6">
                        <el-form-item size="mini" label="领取方式">
                          <el-select
                            v-model="personalForm.reporttake"
                            placeholder=""
                          >
                            <el-option
                    ...
                    <el-row>
                      ...
                      <el-col :span="6">
                        <el-form-item size="mini" label="接害工龄">
                          <el-input
                            v-model="personalForm.harmwordyear"
                          ></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                  ...
                  <div class="checkup_body">
                    <div class="state_group">
                      ...
                      <div class="state_item">
                        ...
                        <div class="state2">
                          {{ personalForm.price || groupPriceTotalCom }}
                        </div>
                      </div>
                      <div class="state_item">
                        <div class="title3">折后价</div>
                        <div class="state3">
                          {{ personalForm.discountprice || afterFoldingPrice }}
                        </div>
                      </div>
                      <div class="state_item">
                    ...
                    <div class="btn_state_gro">
                      <div class="state-add">
                        ...
                        <el-button
                          type="primary"
                          size="mini"
                          @click="handleSelectSetMeal"
                          >开单套餐</el-button
                        >
                        <el-button
                          type="primary"
                          size="mini"
                          @click="handleSelectCmbine"
                          >开单组合</el-button
                        >
                        <!-- <el-button
                        type="primary"
                      ...
                      >
                        ...
                        <el-dropdown-menu slot="dropdown">
                          <el-dropdown-item command="历史项目"
                            >历史项目</el-dropdown-item
                          >
                          <el-dropdown-item command="智能推荐"
                ...
                <div class="checkup_btn-in">
                  <div class="checkup_btn">
                    ...
                    <el-button
                      ...
                      plain
                      style="height: 28px; margin-right: 10px"
                      @click="handleCopyCheckIn('project')"
                      >复制项目</el-button
                    >
                    <el-button
                      class="checkin"
                      ...
                      plain
                      style="height: 28px; margin-right: 10px"
                      @click="handleCopyCheckIn('message')"
                      >复制信息</el-button
                    >
                    <el-button
                      class="checkin"
                  ...
                  <div
                    ...
                    @mouseleave="handlemouseLeaveReset"
                  >
                    <EasyTable
                      row-id="regid"
          ...
          <div class="charge_form">
            ...
            <div class="form_btn">
              ...
              <el-button
                size="mini"
                type="warning"
                @click="handleSetChargeCancel"
                >退费</el-button
              >
              <el-button
                size="mini"
                type="danger"
                @click="handleCloseChargeDetails"
                >取消</el-button
              >
            </div>
          </div>
      ...
      <el-dialog
        title="功能登记"
        :visible.sync="showUseCheckin"
        class="usecheckin_dia"
        width="70%"
        :show-close="false"
      >
        <div class="content_box">
          <div class="searchfor_box">
            <el-input
              ...
              placeholder="请输入检索id"
              v-model="usecheckininput"
              size="mini"
              clearable
              @keyup.native.enter="handlePacsInfoSearchList"
              @clear="handlePacsInfoSearchList"
            >
            </el-input>
            <el-button
              size="mini"
              type="primary"
              @click="handlePacsInfoSearchList"
              >检索</el-button
            >
          </div>
          <div class="table_box">
            ...
            >
              ...
              <vxe-table-column
                ...
                min-width="250"
              ></vxe-table-column>
              <vxe-table-column field="sex" title="操作" width="120">
                <template slot-scope="scope">
                  <el-button
                    size="mini"
                    type="primary"
                    @click="handleDelUseCheckin(scope.row)"
                    >删除登记</el-button
                  >
                </template>
              </vxe-table-column>
        ...
        <span slot="footer" class="dialog-footer">
          <el-button size="mini" @click="handleCloseUseCheckin"
            >取 消</el-button
          >
        </span>
      </el-dialog>
      ...
      >
        ...
        <span slot="footer" class="dialog-footer history_table_footer">
          <el-button size="mini" type="primary" @click="handleSubmitHistory"
            >继 存</el-button
          >
          <el-button size="mini" @click="handleClosehistoryProject"
            >取 消</el-button
          >
        </span>
      </el-dialog>
      ...
      <!-- 批量添加 -->
      <LottoAddProgetto
        v-if="showLottoAddProgetto"
        @submit="showLottoAddProgetto = false"
      />
      <!-- 打印申请单 -->
      <el-dialog title="打印申请单" :visible.sync="showApplyPrint" width="50%">
        ...
        <span slot="footer" class="dialog-footer">
          <el-button size="mini" @click="handleCancelApplyPrint"
            >取 消</el-button
          >
...
export default {
            ...
            return (
              <div style="display: flex;">
                <input
                  ...
                  vOn:change={(e) => {
                    let price = +data.price * +data.discount;
                    data.discountprice = +price.toFixed(2);
                  }}
  ...
  methods: {
    ...
    handleDelUseCheckin(row) {
      ...
      this.$confirm("此操作将删除当前数据, 是否继续?", "提示", {
        ...
        .then(() => {
          PacsInfoDelete({
            regid: row.regid,
            hiscombinecode: row.hiscombinecode,
          }).then((res) => {
            this.$message.success(res.message);
            this.handlePacsInfoList();
          });
        })
        .catch(() => {
          this.$message({
    ...
    //点击关闭功能登记弹框
    handleCloseUseCheckin() {
      this.currentPageUse = 1;
      this.pageSizeUse = 100;
      this.countUse = 0;
      this.usecheckinList = [];
      this.showUseCheckin = false;
    },
    handlePacsInfoSearchList() {
      this.currentPageUse = 1;
      this.pageSizeUse = 100;
      this.handlePacsInfoList();
    },
    ...
    handlePacsInfoList() {
      let whereitems = [];
      if (this.usecheckininput.trim()) {
        whereitems.push({
          key: "regid",
          value: this.usecheckininput.trim(),
        });
      }
      PacsInfoList({
        page: this.currentPageUse,
        limit: this.pageSizeUse,
        whereitems,
      }).then((res) => {
        console.log(res);
        if (!res.result) {
          ...
          this.countUse = res.count;
          this.usecheckinList = res.result;
        }
      });
    },
    ...
    hadnleSendingFees() {
      ...
      sendCostAgain({ regid: this.personalForm.regid })
        .then((res) => {
    ...
    // 当前改变每页条数
    handleSizeChangeUse(val) {
      this.pageSizeUse = val;
      this.currentPageUse = 1;
      this.handlePacsInfoList();
    },
    // 当前改变翻页
    handleCurrentChangeUse(val) {
    ...
    handleSetDiscount() {
      ...
      if (this.pageState == "edit") {
        if (
          !this.personalForm.companycode &&
          this.choosePeople.personalflag == 1
        ) {
          this.$confirm(`团检修改为个人体检，需要先保存，是否保存？`, "提示", {
            confirmButtonText: "是",
            cancelButtonText: "否",
            type: "warning",
          })
          ...
          this.personalForm.companycode &&
          this.choosePeople.personalflag == 0
        ) {
          this.$confirm(
            `个人体检修改为团检体检，需要先保存，是否保存？`,
            "提示",
            {
              confirmButtonText: "是",
              cancelButtonText: "否",
    ...
    handleCheckGroup(value) {
      ...
      if (
        ...
        this.personalForm.combineitems.length
      ) {
        chargeflagItems = this.personalForm.combineitems.map(
          (k) => k.chargeflag
        );
        statusItems = this.personalForm.combineitems
          .map((k) => k.status)
          .filter((k) => k >= 2);
      }
      if (!this.personalForm.companycode && this.personalForm.status > 3) {
        this.$message.warning("已做完所有检查，不允许切换");
        this.personalForm.groupcode = this.choosePeople.groupcode;
        this.personalForm.groupname = this.choosePeople.groupname;
        return;
      } else if (
        (!this.personalForm.companycode && chargeflagItems.includes(1)) ||
        statusItems.length > 0
      ) {
        this.$message.warning("存在已收费或者已体检的项目，不允许切换");
        this.personalForm.groupcode = this.choosePeople.groupcode;
        this.personalForm.groupname = this.choosePeople.groupname;
        return;
      }
      ...
      if (
        ...
        select.sex != 0 &&
        this.personalForm.sex != select.sex
      ) {
        this.$message.warning("所选分组与当前人员性别不匹配!");
        this.personalForm.groupcode = "";
        this.personalForm.groupname = "";
        return;
      }
      this.$confirm("是否保留现有项目?", "提示", {
        confirmButtonText: "是",
        cancelButtonText: "否",
        type: "warning",
        showClose: false,
              ...
              getDetailedList({
                ...
                if (res.result && res.result.length > 0) {
                  ...
                  if (this.pageState == "edit") {
                    ...
                    this.groupTableData.forEach((item) => {
                      price += item.price;
                      discountprice += item.price * item.discount * item.qty;
                      if (item.chargeflag == 1) {
                        actPrice += item.price;
                      }
                    });
                    this.personalForm.price = price.toFixed(2);
                    this.personalForm.discountprice = discountprice.toFixed(2);
                    this.personalForm.actPrice = actPrice.toFixed(2);
                    console.log(this.personalForm.price);
                    console.log(this.personalForm.discountprice);
                    console.log(this.personalForm.actPrice);
                  }
                } else {
                  this.groupTableData = [];
                }
    ...
    handleSelectSetMeal() {
      if (this.pageState === "edit") {
        if (this.personalForm.addCombineFlag == 0) {
          this.$message.warning("当前订单已缴费，不允许修改添加项目");
          return;
        }
        if (this.choosePeople) {
          if (
    ...
    async handleSelectComany(val) {
      ...
      if (!val && this.personalForm.status > 3) {
        this.$message.warning("已做完所有检查，不允许切换");
        this.personalForm.companycode = this.choosePeople.companycode;
        this.personalForm.companyname = this.choosePeople.companyname;
        return;
      } else if (
        (!val && chargeflagItems.includes(1)) ||
        statusItems.length > 0
      ) {
        this.$message.warning("存在已收费或者已体检的项目，不允许切换");
        this.personalForm.companycode = this.choosePeople.companycode;
    ...
    handleGetPersonalDetail(regid) {
      ...
      getPersonalDetail({
        ...
        let data = res.result;
        this.choosePeople = JSON.parse(JSON.stringify(res.result));
        this.personalForm = data;
        this.pageState = "edit";
        this.personalForm.ageunit = "";
        // 年龄单位列表 / 回显值
      ...
      getBatchOrGroup({
        ...
        .then(async (res) => {
          ...
          if (batchitems.length == 0) {
            ...
            let groupobj =
              this.groupitems.filter((k) => k.selected)[0] ||
              this.groupitems[0];
            this.personalForm.groupcode = (groupobj && groupobj.code) || "";
      ...
      getPersonalRegisterList({
        ...
        .then((res) => {
          ...
          if (regid) {
            ...
            this.handleGetPersonalDetail(regid);
    ...
    handlePreview(domId) {
      ...
      switch (domId) {
        ...
        case "btnApply": // 申请单
          ...
          break;
        case "btnHealthTable": // 健康表
          this.$refs.popoverRefIdc.forEach((k) => {
            k.doClose(); // 关闭弹出层popover
          });
          let dom = this.$refs.btnHealthTable[0];
          if (dom.$el.innerText == "健康表打印") {
            let data = {
              fingercode: localStorage.getItem("md5code"),
              codes: [this.choosePeople.regid],
              repname: dom.$attrs["data-remark"],
              whereitems: [
                {
                  key: "regid",
                  value: this.choosePeople.regid,
    ...
    hadnleOnBtnClicked(domId) {
      ...
      switch (domId) {
        case "btnAdd": // 新增
          this.handleCreate();
          break;
        case "btnUseCheckin": // 功能登记
          this.showUseCheckin = true;
          this.handlePacsInfoList();
          break;
        case "btnKeep": // 保存
          this.hadnleSubmit();
          break;
        case "btnSendingFees": // 发送费用
          this.hadnleSendingFees();
          break;
        case "btnDel": // 删除
          this.hadnleDelList();
          break;
