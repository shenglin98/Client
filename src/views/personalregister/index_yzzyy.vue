              ...
              <div class="basicInfo">
                ...
                <div v-if="message == 'other'" class="other_info">
                  ...
                  >
                    <el-row>
                      <el-col :span="8">
                        <el-form-item size="mini" label="户籍所在地">
                          <el-input
                    ...
                    <el-row>
                      ...
                      <el-col :span="8">
                        <el-form-item size="mini" label="学历">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      checkupDateArr: ["日期范围", "体检时间"], // 检索条件身份证等数组
  ...
  methods: {
    ...
    handleGetPersonalRegisterList(pageflag) {
      ...
      if (this.conditionDate && this.conditionDate.length > 0) {
        ...
        whereitems.push({
          key:
            this.conditionDateText == "日期范围" ? "enddate" : "endcheckdate",
      ...
      this.$axios
        ...
        .then((res) => {
          if (res.data.resultFlag == 0) {
            ...
            data.certAddress && (this.personalForm.address = data.certAddress);
      ...
      this.$axios
        ...
        .then((res) => {
          if (res.data.code != -1) {
            ...
            data.address && (this.personalForm.address = data.address);
    ...
    handlePrintGuideSingle() {
      ...
      if (d.$el.innerText == "指引单打印") {
        ...
        let repname = "";
        if (this.choosePeople.checktype == 8) {
          repname = `${indexP}指引单`;
