        ...
        <el-col :span="8">
          <div class="content_left">
            ...
            <div class="checkup_btn">
              ...
              <el-button plain type="primary" size="mini" @click="handleChangeStatus(0,0)">待签到</el-button>
              <el-button plain type="primary" size="mini" @click="handleGetSign(0)">已签到</el-button>
              <el-button plain type="primary" size="mini" @click="handleChangeStatus(2,-1)">待交表</el-button>
...
export default {
  ...
  methods: {
    ...
    // 点击检索条件改变状态回调
    handleChangeStatus(value, timetype1) {
      this.status = value;
