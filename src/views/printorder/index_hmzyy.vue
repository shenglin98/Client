  ...
  <div class="print_order">
    ...
    <el-card class="box-card search_box">
      ...
      >
        ...
        <el-row>
          <el-col :span="6" class="name_post" label-width="50px">
          ...
          <el-col :span="6">
            <el-form-item size="mini" label="预约日期">
              <el-date-picker
                style="width: 250px"
                @change="handleChangeCheckDate"
                @clear="handleGetPrintOrderList"
                size="mini"
                v-model="checkDate"
                type="daterange"
                align="right"
    ...
    />
    <el-dialog
      class="printBarCodeDia"
      title="打印条码"
      :visible.sync="showBarCode"
    ...
    >
      <div class="contnet">
        ...
        <el-checkbox-group
          v-model="barCodeOptions"
          @change="handleCheckedBarCodeOptions"
        >
          <el-checkbox
            v-for="(item, index) in barCodeItem"
            :label="item.key"
            :key="index"
      ...
      <span slot="footer" class="dialog-footer">
        <el-button
          ...
          >取 消</el-button
        >
        <el-button size="mini" type="primary" @click="handlePrintBarCode"
          >打 印</el-button
        >
      </span>
    </el-dialog>
    ...
    handleGetPrintDate() {
      getSysConfigInfo({ cc: "Sys_FullSearch_DateRange" }).then((res) => {
        ...
        let time = new Date(+new Date() + 8 * 3600 * 1000)
          ...
          .substr(0, 10)
          .replace("T", " ");
        this.checkDate = [`${time} 00:00:00`, `${time} 23:59:59`];
        this.searchForm.startcheckdate = `${time} 00:00:00`;
        this.searchForm.endcheckdate = `${time} 23:59:59`;
      });
    },
    gettime(data) {
      let value =
