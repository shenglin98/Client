  ...
  <div class="print_order">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item size="mini" label="单位名称">
              <el-select class="select100" v-model="searchForm.companycode" clearable filterable remote reserve-keyword :remote-method="handleRemoteMethod" :loading="selectLoading" @clear="handleRemoteMethod" @change="handleChangeCompany">
          ...
          <el-col :span="4">
            <el-form-item size="mini" label="批次">
              <el-select class="select100" v-model="searchForm.batch" clearable placeholder="请选择批次" @change="handleChangeBatch">
          ...
          <el-col :span="4">
            <el-form-item size="mini" label="分组">
              <el-select class="select100" v-model="searchForm.groupcode" clearable placeholder="请选择分组" @change="handleChangeGroup">
          ...
          <el-col :span="4">
            <el-form-item size="mini" label="性别">
              <el-select class="select100" v-model="searchForm.sex" clearable placeholder="请选择性别" @change="handleGetPrintOrderList">
          ...
          <el-col :span="4">
            <el-form-item size="mini" label="婚姻状况">
              <el-select class="select100" v-model="searchForm.marriage" clearable placeholder="请选择婚姻" @change="handleGetPrintOrderList">
        ...
        <el-row>
          ...
          <el-col :span="4">
            <el-form-item size="mini" label="部门">
              <el-select class="select100" v-model="searchForm.departcode" clearable placeholder="请选择部门" @change="handleGetPrintOrderList">
          ...
          <el-col :span="4">
            <el-form-item size="mini" label="状态">
              <el-select class="select100" v-model="searchForm.status" clearable placeholder="请选择状态" @change="handleGetPrintOrderList">
          ...
          <el-col :span="4" class="hebing">
            ...
            <el-button type="primary" size="mini" plain @click="handleGetPrintOrderList">搜 索</el-button>
          </el-col>
        </el-row>
      </el-form>
    </el-card>
    ...
    <div class="table_box">
      ...
      <el-card class="box-card table_left">
        ...
        <!-- 人员表格数据 -->
        <EasyTable class="staff_table" :loading="loading" row-key="regid" height="100%" :data="staffTableData" ref="staffTable" :tableOptions="staffTableOption" @row-click="handleChoosePeople" :checkbox-config="{ fetch: true, rowClick: true }" @selection-change="handleSelectStaff" :border="false" :header-cell-style="handleReturnStyle" :row-class-name="handleTableRowClassName" :row-style="{ height: '32px' }" :cell-style="{ padding: '0' }" />
        <div class="fenye">
...
export default {
  ...
  methods: {
            ...
            if (d.$el.innerText == "打印指引单") {
              ...
              for (let i = 0; i < this.chooseStaffList.length; i++) {
                await this.handlePrintGuidanceApi(
                  this.chooseStaffList[i].regid,
                  d.$attrs["data-remark"]
                );
                if (
                  this.chooseStaffList[i].billprintcombines &&
                  this.chooseStaffList[i].billprintcombines.length > 0
                ) {
                  await this.handlePrintApplyApi(
                    this.chooseStaffList[i],
                    "3、申请单"
                  );
                }
    ...
    // 打印申请单
    handlePrintApplyApi(item, repname) {
      return new Promise((resolve, reject) => {
        try {
          let data = {
            fingercode: localStorage.getItem("md5code"),
            ...
            whereitems: [
              ...
              {
                key: "combinecodesin",
                valueList: item.billprintcombines,
              },
            ],
          };
          printStaticsBase64(data).then((res) => {
    ...
    handlePrintGuidanceApi(regid, repname) {
      return new Promise((resolve, reject) => {
        try {
          let data = {
            fingercode: localStorage.getItem("md5code"),
          ...
          for (let i = 0; i < this.chooseStaffList.length; i++) {
            ...
            let data = {
              ...
              whereitems: [
                ...
                {
                  key: "combinecodesin",
                  valueList: this.chooseStaffList[i].billprintcombines,
                },
              ],
            };
            printBase64(data).then((res) => {
    ...
    hadnleOnBtnClicked(domId) {
      ...
      switch (domId) {
        ...
        case "btnGuidance": // 打印指引单
          ...
          break;
        case "btnGuideSingleAndApply": // 打印指引单+申请单
          this.handlePrintGuidance(true);
          break;
        case "btnOnekey": // 一键打单
