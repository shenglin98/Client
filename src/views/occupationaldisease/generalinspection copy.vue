              ...
              <div class="check_left">
                ...
                <el-scrollbar class="check_b">
                  ...
                  <div v-if="checkActive == 'depart'" class="dom3">
                    ...
                    <el-button type="primary" size="mini" style="width:30%" @click="dialogProjectReviewFlag = true, Review()">项目复查</el-button>
                    <!-- 项目复查 -->
                    <el-dialog title="项目复查" :close-on-click-modal="false" :visible.sync="dialogProjectReviewFlag">
                      ...
                      <!-- 添加项目组件 -->
                      <SetMealDialog v-if="dialogInsideFlag" :groupTableData="groupTableData" @submit="handleProjectSubmit" @close="showProjectDialog = false" />
              ...
              <div class="check_right">
                ...
                <div class="check_b jkjyBom" ref="checkL">
                  ...
                  <div v-for="(item, index) in worditems" :key="index">
                    ...
                    <el-checkbox-group v-if="item.wordname.length > 0 &&
                                            checkActive == 'describe' &&
                                            activeName == 'jkjy'
                                            " class="dom1 item_drag" v-model="checkAdvise1">
...
export default {
  ...
  data() {
    return {
      ...
      tinymceFlag1: 1,
      tinymceFlag2: 1,
      checkActive: "describe", // 左侧当前选中标签页 describe  contrast  depart  totalCheck  archives  beginning complex
      checkActiveItem: "briefSummary", //  初检 复检 下面的两个按钮  briefSummary=项目小结  checkTheResults = 检查结果
  ...
  methods: {
    ...
    ProjectReviewDel(row) {
      console.log(row, "点击删除的数据");
      let result = this.DialogProjectReviewData.findIndex(
        (item) => item.checkcode == row.checkcode
      );
    ...
    handleGetRegisterInfo() {
      ...
      getRegisterInfo(data).then((res) => {
        ...
        console.log(this.choosePers, "this.choosePers");
