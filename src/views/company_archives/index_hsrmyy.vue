...
import * as company_archives from "@/api/company_archives_hsrmyy";
...
export default {
  ...
  methods: {
    ...
    handleBulkEditing() {
      ...
      const result = this.multipleSelection.map((k) => k.companycode);
      company_archives.ModifyOrganization(result).then((res) => {
        console.log(res);
        if (res.code == 200) {
    ...
    onBtnClicked: function (domId) {
      switch (domId) {
        ...
        case "btnClose": // 关闭当前页面
          ...
          break;
        case "btnBulkEditingBame": // 批量修改单位名称
          this.handleBulkEditing();
          break;
        default:
          break;
      }
