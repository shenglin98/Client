        ...
        <el-row style="margin-bottom: 5px">
          ...
          <el-col :span="6">
            <el-form-item size="small" label="折扣">
              <el-input
                v-model="bodyForm.discount"
                @change="handleChangeDiscountTest"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6" v-if="fileUrl != ''">
        ...
        >
          ...
          <el-table-column prop="qty" label="数量" show-overflow-tooltip>
            <template slot-scope="scope">
              <input
                ...
                :max="1"
                :min="0"
                v-model.lazy.number="scope.row.qty"
                @keyup.enter="handleAloneDiscountQty(scope.row)"
              />
            </template>
          </el-table-column>
          ...
          >
            <template slot-scope="scope">
              ...
              <span v-else>{{
                (scope.row.qty * scope.row.price * +scope.row.discount).toFixed(
                  2
                )
              }}</span>
            </template>
