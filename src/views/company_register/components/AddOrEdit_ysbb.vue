        ...
        <el-row style="margin-bottom: 5px">
          <el-col :span="6">
            <el-form-item size="small" label="报告控制">
              <el-select
                style="width: 100%"
                v-model="bodyForm.viewreportsettlement"
                clearable
                filterable
                placeholder=""
              >
    ...
    >
      ...
      <el-card class="box-card combineitems">
        ...
        >
          ...
          <el-table-column prop="isOptional" label="必选" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-checkbox v-model="scope.row.isOptional"></el-checkbox>
            </template>
          </el-table-column>
        </el-table>
      ...
      <div class="appointdate_content">
        ...
        <div class="appdatec_table">
          <EasyTable
            ...
            height="100%"
            :data="appdateList"
            :tableOptions="appdateListOptions"
