<template>
  <div class="company_register">
    <div v-if="!showAddOrEdit" class="filter-box">
      <div class="filter-container">
        <div class="filter-container-in">
          ...
          关键字搜索：<el-input @keyup.enter.native="handleFilter" size="mini" style="width: 300px; margin-right: 20px" class="filter-item" :placeholder="'名称'" v-model="searchWord">
          </el-input>
      ...
      <div class="app-container">
        ...
        <div class="bg-white" style="height: calc(100vh - 210px)">
          <el-table ref="mainTable" min-width="500" height="100%" stripe :row-style="{ height: '32px' }" :cell-style="{ padding: '0px' }" :header-cell-style="{
            ...
            <el-table-column prop="email" label="收费状态" show-overflow-tooltip width="120">
              <template slot-scope="scope">
                <el-select class="filter-item" size="mini" filterable v-model="scope.row.coststatus" @change="handleChangeCoststatus(scope.row)">
    ...
    <transition name="fade" mode="in-out">
      <AddOrEdit v-if="showAddOrEdit" @submit="handleSubmitSuccess" :editObj="editObj" :addOrEdit="addOrEdit" @close="showAddOrEdit = false" />
    </transition>
  </div>
</template>
...
// 添加编辑子组件
import AddOrEdit from "./components/AddOrEdit_qyzyy.vue";
