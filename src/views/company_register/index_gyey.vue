    ...
    <div v-if="!showAddOrEdit" class="filter-box">
      <div class="filter-container">
        <div class="filter-container-in">
          ...
          <el-input @keyup.enter.native="handleFilter" size="mini" style="width: 300px; margin-right: 20px" class="filter-item" :placeholder="'名称'" v-model="searchWord">
          </el-input>
      ...
      <div class="app-container">
        ...
        <div class="bg-white" style="height: calc(100vh - 210px)">
          <el-table ref="mainTable" min-width="500" height="100%" stripe :row-style="{ height: '32px' }" :cell-style="{ padding: '0px' }" :header-cell-style="{
            ...
            <el-table-column width="250px" align="left" prop="companyname" label="单位名称" show-overflow-tooltip>
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item size="small" :label="'体检时间'" prop="Startdate">
                  <el-date-picker v-model="addtemp.Startdate" type="date" placeholder="选择日期">
                  </el-date-picker>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item size="small" :label="'至'" prop="Enddate">
                  <el-date-picker v-model="addtemp.Enddate" type="date" placeholder="选择日期">
                  </el-date-picker>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item size="small" :label="'预约时间'" prop="Registerdate">
                  <el-date-picker v-model="addtemp.Registerdate" type="date" placeholder="选择日期">
                  </el-date-picker>
                </el-form-item>
              </el-col>
              <el-col :span="6">
...
import { setFinishYes, SetFinishNo } from "@/api/company_register.js";
import { GetCompanyResult } from "@/api/customerresult.js";
...
// 添加编辑子组件
import AddOrEdit from "./components/AddOrEdit_gyey.vue";
...
export default {
  ...
  methods: {
    ...
    handleGetCompanyResult(data) {
      ...
      GetCompanyResult({ companycode: data.companycode, batch: data.batch })
        .then((res) => {
    ...
    handleGetSysConfigInfo() {
      getSysConfigInfo({ cc: "Sys_Company_register_DateRange" }).then((res) => {
        ...
        this.queryDate = ["2021-01-01", this.gettime(end)];
        this.getList();
      });
    },
    handleGetPrintDate() {
    ...
    onBtnClicked: function (domId) {
      ...
      switch (domId) {
        ...
        case "btnBatchExtract":
          ...
          this.handleGetCompanyResult(this.multipleSelection[0]);
          break;
        case "btnEdit":
          if (this.multipleSelection.length !== 1) {
            this.$message({
