    ...
    <sticky :className="'sub-navbar'">
      <div class="filter-container" ref="btndiv" id="btndiv">
        ...
        <el-button
          ...
          :disabled="btndised"
          size="mini"
          v-for="(btn, index) of typesBtns"
          v-bind:key="btn.Id"
          class="filter-item"
          @click="onBtnClicked(btn, $event)"
          :ref="'btn_' + index"
          >{{ btn.name }}</el-button
        >
        <el-button
      ...
      <el-row :gutter="4" class="fh">
        <el-col :span="5" class="fh ls-border">
          ...
          <el-card
            shadow="never"
            class="body-small fh"
            style="overflow: auto; height: calc(100vh - 183px)"
          >
            <el-tree
              ref="tree"
              :data="typetree"
          ...
          <div class="bg-white fh">
            <el-form ref="workform" :model="paramsSettingForm">
              ...
              >
                  ...
                  <div style="margin: 10px">
                    <el-row>
                      <el-col :span="5">
                        ...
                        >
                          <el-input
                            v-model="paramsSettingForm.wordtemp.conid"
                            :disabled="true"
                            size="small"
                            placeholder="系统自动处理"
                          ></el-input>
                      ...
                      <el-col :span="12">
                        ...
                        >
                          <el-input
                            v-model="paramsSettingForm.wordtemp.name"
                    ...
                    <el-row>
                      <el-col :span="5">
                        <el-form-item
                          ...
                          size="small"
                          :label="'ICD编码'"
                          :prop="'wordtemp.icdcode'"
                        >
                          <el-input
                            v-model="paramsSettingForm.wordtemp.icdcode"
                            :disabled="worddisabled"
                            size="small"
                          ></el-input>
                        </el-form-item>
                      ...
                      <el-col :span="5">
                        <el-form-item
                          ...
                          size="small"
                          :label="'ICD名称'"
                          :prop="'wordtemp.icdname'"
                        >
                          <el-input
                            v-model="paramsSettingForm.wordtemp.icdname"
                            :disabled="worddisabled"
                            size="small"
                          ></el-input>
                        </el-form-item>
                      ...
                      <el-col :span="5">
                        ...
                        >
                          <el-select
                            ...
                            clearable
                            :disabled="worddisabled"
                            v-model="paramsSettingForm.wordtemp.sex"
                          >
                            <el-option
                      ...
                      <el-col :span="7">
                        ...
                        >
                          <el-select
                            v-model="paramsSettingForm.wordtemp.level"
                            clearable
                            placeholder="请选择"
                          >
                    ...
                    <el-row>
                      <el-col :span="5">
                        ...
                        >
                          <el-select
                            ...
                            clearable
                            :disabled="worddisabled"
                            v-model="paramsSettingForm.wordtemp.flag"
                          >
                            <el-option
                      ...
                      <el-col :span="5">
                        <el-form-item
                          ...
                          size="small"
                          :label="'输入码'"
                          :prop="'wordtemp.incode'"
                        >
                          <el-input
                            v-model="paramsSettingForm.wordtemp.incode"
                            :disabled="worddisabled"
                            size="small"
                          ></el-input>
                        </el-form-item>
                      ...
                      <el-col :span="5">
                        ...
                        >
                          <el-input
                            v-model="paramsSettingForm.wordtemp.seqno"
                            :disabled="worddisabled"
                            size="small"
                          ></el-input>
                        </el-form-item>
                      ...
                      <el-col :span="7">
                        ...
                        >
                          <el-select
                            ...
                            clearable
                            :disabled="worddisabled"
                            v-model="paramsSettingForm.wordtemp.status"
                          >
                    ...
                    <el-row>
                      <el-col :span="5">
                        ...
                        >
                          <el-select
                            ...
                            clearable
                            :disabled="worddisabled"
                            v-model="paramsSettingForm.wordtemp.trackflag"
                          >
                      ...
                      <el-col :span="5">
                        <el-form-item
                          ...
                          size="small"
                          :label="'回访天数'"
                          :prop="'wordtemp.trackday'"
                        >
                          <el-input
                            v-model.number="paramsSettingForm.wordtemp.trackday"
                            :disabled="worddisabled"
                            size="small"
                          ></el-input>
                        </el-form-item>
                      ...
                      <el-col :span="5">
                        ...
                        >
                          <el-select
                            ...
                            clearable
                            :disabled="worddisabled"
                            v-model="paramsSettingForm.wordtemp.criticalflag"
                          >
                            <el-option
                              v-for="item in criticalflagarr"
                              :key="item.key"
                              :label="item.name"
                              :value="item.key"
                            >
                      ...
                      <el-col :span="7">
                        ...
                        >
                          <el-select
                            ...
                            collapse-tags
                            :disabled="worddisabled"
                            v-model="paramsSettingForm.wordtemp.illcodeitems"
                          >
                            <el-option
                              v-for="item in illitems"
                              :key="item.code"
                              :label="item.name"
                              :value="item.code"
                            >
                        ...
                        >
                          ...
                          >
                            <el-input
                              ...
                              style="height: 100%"
                              :disabled="worddisabled"
                              v-model="paramsSettingForm.wordtemp.healthadvice"
                            ></el-input>
                        ...
                        >
                          ...
                          >
                            <el-input
                              ...
                              style="height: 100%"
                              :disabled="worddisabled"
                              v-model="paramsSettingForm.wordtemp.dietadvice"
                            ></el-input>
                        ...
                        >
                          ...
                          >
                            <el-input
                              ...
                              style="height: 100%"
                              :disabled="worddisabled"
                              v-model="paramsSettingForm.wordtemp.sportsadvice"
                            ></el-input>
                ...
                <el-tab-pane label="结论推导" name="second">
                  <div style="margin: 10px">
                    ...
                    <el-table
                      ...
                      :data="paramsSettingForm.wordtemp.relationitems"
                      ref="table"
                      tooltip-effect="dark"
                      border
                      stripe
                    ...
                    >
                      ...
                      >
                        <template slot-scope="scope">
                          ...
                          >
                            <el-option
                              v-for="item in deptypesarrItems"
                              :key="item.code"
                ...
                <el-tab-pane label="建议记录" name="record">
                  <div class="disease_table_box">
                    <!-- <el-table
                      :data="chooseTypeData"
                      class="disease_table"
                      :border="false"
                    ...
                    >
                      ...
                      <el-table-column prop="status" label="禁用标志" sortable>
                        <template slot-scope="scope">
                          <span>{{
                    ...
                    <vxe-table
                      ...
                      :data="chooseTypeDataSS"
                      :checkbox-config="{ trigger: 'row' }"
                      @cell-click="handleCheckChooseType"
                      :header-cell-style="handleReturnStyle"
                      :row-class-name="handleTableRowClassName"
                    >
                      <vxe-table-column
        ...
        >
          ...
          <el-form-item size="small" :label="'科室'" prop="deptcode">
            <el-select
              ...
              filterable
              style="width: 100%"
              v-model="typetemp.deptcode"
            >
              <el-option
                v-for="item in deptypesarr"
                :key="item.code"
                :label="item.name"
                :value="item.code"
              >
...
export default {
  ...
  computed: {
    ...
    chooseTypeDataSS() {
      ...
      if (search) {
        return this.chooseTypeData.filter((data) => {
          return Object.keys(data).some((key) => {
            let containArr = ["conid", "name"];
  ...
  methods: {
    ...
    handleCheckChooseType({ row }) {
      ...
      this.currentNodeId = this.typedata.conid;
      if (
        ...
        conclusions.getWordDetail(condata).then((response) => {
          ...
          this.illitems = response.result.illitems;
        });
      } else {
    ...
    handleNodeClick(data, a, b) {
      ...
      if (data.children && data.children.length > 0) {
        // this.chooseTypeData = data.children.filter((k) => {
        //   return k.isFile;
        // });
        let tempData = data.children.filter((k) => {
          return k.isFile;
        });
        if (tempData.length == 0) return;
        let conids = tempData.map((k) => {
          return k.word.word.conid;
        });
        // return;
        LoadWordList(conids).then((res) => {
          if (!res.result) return;
          this.chooseTypeData = res.result;
        });
      }
      this.typedata = JSON.parse(JSON.stringify(data));
      if (
        ...
        conclusions.getWordDetail(condata).then(async (response) => {
          this.items = response.result.items;
          this.relationitemslist = response.result.relationitemslist;
          this.paramsSettingForm.wordtemp.relationitems =
            response.result.relationitems;
      ...
      this.isDelIdCheck = this.typeid;
    },
    // 递归选中结论词
    handleSelectConclusionWords(data) {
      if (!data.isFile && data.children.length > 0) {
        console.log(this.$refs[`treeItem_${this.currentNodeId}`], "文件夹");
        this.handleSelectConclusionWords(data.children[0]);
        console.log(data, "文件夹");
      } else {
        setTimeout(() => {
          console.log(data, "结论词");
          console.log(this.$refs[`treeItem_${this.currentNodeId}`], "结论词");
          this.handleChooseTRee(data);
        }, 2000);
        // 页面加载默认选中第一个
        // this.$nextTick(() => {
        //   this.currentNodeId = data.id;
              ...
              }
              {
                this.$refs["workform"].validate((valid) => {
                  ...
                  if (valid) {
                    ...
                    delete this.paramsSettingForm.wordtemp.illitems;
                    conclusions
                    ...
                    return;
                    if (
                      this.paramsSettingForm.wordtemp.illcodeitems.length === 0
                    ) {
                      this.$confirm(`疾病大类为空，请选择疾病大类`, "提示", {
                        confirmButtonText: "是",
                        cancelButtonText: "否",
                        type: "warning",
                        showClose: false,
    ...
    getList(resetFlag) {
      ...
      conclusions.getList(this.listQuery).then((response) => {
        ...
        this.$nextTick(() => {
          ...
          console.log(this.isDelIdCheck, "this.isDelIdCheck");
          if (resetFlag) {
            this.filterText = temp;
          }
          if (this.isDelete && this.isDelIdCheck) {
            this.defaultChecked.push(this.isDelIdCheck);
            this.$refs[`treeItem_${this.isDelIdCheck}`].click();
            this.isDelIdCheck = "";
            this.isDelete = false;
