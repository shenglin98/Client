                      ...
                      <el-col :span="5">
                        ...
                        >
                          ...
                          >
                            ...
                            <el-option label="进一步治疗" :value="1">
                            </el-option>
                            <el-option label="立马治疗" :value="2"> </el-option>
                          </el-select>
                        </el-form-item>
                      </el-col>
                    </el-row>
                  ...
                  <div style="margin: 10px">
                    ...
                    >
                      ...
                      >
                        <template slot-scope="scope">
                          <el-checkbox
                            v-model="scope.row.criticalflag"
                            :false-label="0"
                            :true-label="1"
                            size="mini"
                            :disabled="worddisabled"
...
export default {
  ...
  methods: {
    // handleChangeCombineCode(value) {
    //   if (!value) return;
    //   console.log(value, "value");
    //   getDicCombineDetail({ code: value.combinecode }).then((res) => {
    //     console.log(res);
    //     value.deptypesarrItems = res.result;
    //   });
    // },
    // 关闭当前页面回调
    handleClosePage() {
