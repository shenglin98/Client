...
export default {
  ...
  methods: {
    ...
    changePassword() {
      ...
      let newpwd = encryptor.encrypt(this.$Base64.encode(_this.newpwd)); // 对内容进行加密
      // _this.newpwd = this.$Base64.encode(_this.newpwd);
      users
        .changePassword({
