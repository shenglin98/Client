<template>
  <div class="total_check">
            ...
            <div class="check_body">
              ...
              <div class="check_right">
                ...
                <el-scrollbar class="check_b">
                  ...
                  <!-- 饮食建议文本域 ysjy -->
                  <el-input v-if="activeName == 'ysjy' && dietadviceText != ''" class="ysjy" type="textarea" resize="none" :disabled="pageStatus" v-model="dietadviceText"></el-input>
                  <!-- 运动建议文本域 ydjy -->
                  <el-input v-if="activeName == 'ydjy' && sportsadviceText != ''" class="ydjy" type="textarea" resize="none" :disabled="pageStatus" v-model="sportsadviceText"></el-input>
                  <!-- 健康知识文本域 jkzs -->
                  <el-input v-if="activeName == 'jkzs' && healthknowledgeText != ''" class="jkzs" type="textarea" resize="none" :disabled="pageStatus" v-model="healthknowledgeText"></el-input>
                  <!-- 历史对比 dom2 contrast   -->
                  <div v-if="checkActive == 'contrast'" class="dom2">
    ...
    <!-- 健康建议拖拽弹框 -->
    <el-dialog title="" class="summaryDia" top="8%" :visible.sync="showMoveConclusion" width="400px" :close-on-click-modal="false" :close-on-press-escape="false" :show-close="false" @open="handleOpenMoveConclusion">
      <div class="handle_btn_group">
        ...
        case "btnReport": // 报告书
          this.$refs.popoverRefIdc.forEach((d) => {
            if (d.$children[0].$el.innerText == "报告书") {
              ...
              } else if (this.currentPeople.meccode == 10007) {
