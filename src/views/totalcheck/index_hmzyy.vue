<template>
  <div class="total_check">
              ...
              <el-row>
                ...
                <el-col :span="4">
                  <el-form-item size="mini" label="打印时间">
                    <el-input
                      v-model="currentPeople.reportprintdate"
                    ></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                ...
                <el-col :span="4">
                  <el-form-item size="mini" label="收费状态">
                    <el-input
                      :class="[currentPeople.chargeflag == 1 ? 'is_red' : '']"
                      v-model="currentPeople.chargeflagcn"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="4">
      ...
      <el-row class="content_box">
        <el-col :span="5" class="personnel_box">
          <div class="pers_table_box">
            ...
            <el-date-picker
              style="width: 100%; margin: 3px 0 4px 0"
              v-model="screenData"
              type="daterange"
              range-separator="-"
              size="mini"
          ...
          <div class="comb_table_box">
            ...
            <EasyTable
              ...
              height="100%"
              :data="combData"
              :tableOptions="combOptions"
              :radio-config="{
                rowClick: true,
              }"
              @row-click="handleChooseComb"
              :border="false"
              :header-cell-style="handleReturnStyle"
              :row-class-name="handleTableRowClassName"
              :row-style="{ height: '32px' }"
              ...
              <div class="check_left">
                <div class="radio_box">
                  ...
                  >
                    ...
                    <el-radio-button label="totalCheck"
                      >历史总检</el-radio-button
                    >
              ...
              <div class="check_right">
                ...
                >
                  <el-tabs v-model="activeName">
                    <el-tab-pane label="健康建议" name="jkjy"
                      >健康建议</el-tab-pane
                    >
                    <el-tab-pane label="饮食建议" name="ysjy"
                      >饮食建议</el-tab-pane
                    >
                    <el-tab-pane label="运动建议" name="ydjy"
                      >运动建议</el-tab-pane
                    >
                    <el-tab-pane label="健康知识" name="jkzs"
                      >健康知识</el-tab-pane
                    >
                  </el-tabs>
                ...
                <el-scrollbar class="check_b">
                  ...
                  <div v-for="(item, index) in worditems" :key="index">
                    ...
                    >
                      ...
                      >
                        <el-checkbox
                          v-for="(val, ind) in item.wordname"
                          :key="ind"
                          class="dom1_item"
                          :label="val"
                        >
                              ...
                              <div class="item_top dom1_item_top">
                                ...
                                <div class="text_h_check" style="width: 50%">
                                  ...
                                  <el-row>
                                    ...
                                    <el-col
                                      :span="7"
                                      class="departmentClas checkFlex"
                                    >
                                      <div>
                                        科室:
                                        <el-select
                  ...
                  <!-- 饮食建议文本域 ysjy -->
                  <el-input
                    v-if="activeName == 'ysjy' && dietadviceText != ''"
                    class="ysjy"
                    type="textarea"
                    resize="none"
                    v-model="dietadviceText"
                  ></el-input>
                  <!-- 运动建议文本域 ydjy -->
                  <el-input
                    v-if="activeName == 'ydjy' && sportsadviceText != ''"
                    class="ydjy"
                    type="textarea"
                    resize="none"
                    v-model="sportsadviceText"
                  ></el-input>
                  <!-- 健康知识文本域 jkzs -->
                  <el-input
                    v-if="activeName == 'jkzs' && healthknowledgeText != ''"
                    class="jkzs"
                    type="textarea"
                    resize="none"
                    v-model="healthknowledgeText"
                  ></el-input>
                  <!-- 历史对比 dom2 contrast   -->
                  <div v-if="checkActive == 'contrast'" class="dom2">
                    <EasyTable
            ...
            <div class="check_form">
              ...
              >
                ...
                <el-form-item size="mini" label="审核医生">
                  ...
                  <el-select
                    v-model="currentPeople.checkcode"
                    clearable
                    @change="handleChangeCheckCode"
                  >
                    <el-option
                      v-for="(item, index) in currentPeople.doctoritems"
                      :key="index"
                ...
                <el-form-item size="mini" label="状态">
                  <el-input
                    v-model="currentPeople.statuscn"
                    disabled
                  ></el-input>
                </el-form-item>
              </el-form>
    ...
    <el-dialog
      title="复查/转诊"
      :visible.sync="showFollowUpReferral"
      width="1000px"
      class="dia_followUpReferral"
      :show-close="false"
    ...
    >
      <div class="dfur_content" v-if="worditems && worditems[0]">
        <div
          class="dfur_citem"
          v-for="val in worditems[0].wordname"
          :key="val.uniqueid"
        >
          ...
          <div class="control_box">
            ...
            <el-date-picker
              ...
              :disabled="val.transferstatus == 0"
              v-model="val.followdate"
              type="date"
              placeholder="选择日期"
              size="mini"
            ...
            <el-input
              ...
              :disabled="val.followstatus == 0"
              placeholder="请输入内容"
              v-model="val.transferdes"
              clearable
              type="textarea"
              resize="none"
              size="mini"
      ...
      <span slot="footer" class="dialog-footer">
        <el-button size="mini" @click="showFollowUpReferral = false"
          >关 闭</el-button
        >
      </span>
    </el-dialog>
    ...
    <el-dialog
      ...
      class="summaryDia"
      top="5vh"
      :visible.sync="showMoveConclusion"
      width="1000px"
      :close-on-click-modal="false"
      :close-on-press-escape="false"
      :show-close="false"
      @open="handleOpenMoveConclusion"
    >
      <div class="handle_btn_group">
        <div class="handle_btn" @click="handleDelWordItems">
      ...
      <span slot="footer" class="dialog-footer" style="text">
        <el-button
          type="primary"
          size="mini"
          @click="showMoveConclusion = false"
          >关 闭</el-button
        >
      </span>
    </el-dialog>
          ...
          <div class="conclusion_box">
            ...
            <div class="conc_input">
              <el-form ref="form" :model="chooseDepart" label-width="80px">
                <el-form-item size="mini" label="检查医生">
                  <el-input
                    v-model="chooseDepart.doctorname"
                    disabled
                  ></el-input>
                </el-form-item>
                <el-form-item size="mini" label="检查时间">
                  <el-input
                    v-model="chooseDepart.checkdate"
                    disabled
                  ></el-input>
                </el-form-item>
              </el-form>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button
          ...
          >取 消</el-button
        >
        <el-button size="mini" type="primary" @click="handleSelectPrintDiaCover"
          >打印封面</el-button
        >
      ...
      this.$refs.popoverRefIdc.forEach((d) => {
        if (d.$children[0].$el.innerText == "报告书") {
          ...
          printBase64(data).then((res) => {
            ...
            this.lodop.SET_PRINT_MODE("PRINT_START_PAGE", 0); // 设置从第2页开始打印;
        ...
        if (d.$children[0].$el.innerText == "报告书") {
          ...
          printBase64(data).then((res) => {
            ...
            this.lodop.SET_PRINT_MODE(
              "PRINT_START_PAGE",
              +this.selectPrintStart + 1
            ); // 设置从第2页开始打印;
            this.lodop.SET_PRINT_MODE(
              "PRINT_END_PAGE",
              +this.selectPrintEnt + 1
            ); // 设置从第3页结束打印;
            printObj.printBase64PdfReport(this.lodop, fileList);
            this.showSelectPrint = false;
            this.selectPrintStart = "";
