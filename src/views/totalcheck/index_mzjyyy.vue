<template>
  <div class="total_check">
    ...
    <div class="subject">
      ...
      <div class="search_box">
        ...
        <el-row class="search_body">
          ...
          <el-col :span="19" class="form_box">
            <el-form ref="form" label-width="80px">
              <el-row>
                <el-col :span="5">
                  <el-form-item size="mini" class="regid_item" label="体检号">
                    <el-input v-model="currentPeople.regid" disabled></el-input>
                    <!-- <el-checkbox
                      :true-label="1"
                      :false-label="0"
                      :disabled="disabledIsused"
                      v-model="currentPeople.isused"
                      @change="handleChangeIsused"
                    ></el-checkbox> -->
                  </el-form-item>
                </el-col>
                <el-col :span="5">
                  <el-form-item size="mini" label="姓名">
                    <el-input v-model="currentPeople.name" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="3">
                  <el-form-item size="mini" label="性别">
                    <el-input v-model="currentPeople.sex" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="3">
                  <el-form-item size="mini" label="年龄">
                    <el-input v-model="currentPeople.age" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item size="mini" label="婚姻">
                    <el-input v-model="currentPeople.marriage" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item size="mini" label="录入状态">
                    <el-input v-model="currentPeople.inputstatuscn" disabled></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="5">
                  <el-form-item size="mini" label="联系电话">
                    <el-input v-model="currentPeople.telephone" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="5">
                  <el-form-item size="mini" label="身份证">
                    <el-input v-model="currentPeople.idcard" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="5">
                  <el-form-item size="mini" label="体检类型">
                    <el-input v-model="currentPeople.checktypeCN" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="5">
                  <el-form-item size="mini" label="打印状态">
                    <el-input v-model="currentPeople.reportprintcn" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item size="mini" label="打印时间">
                    <el-input v-model="currentPeople.reportprintdate" disabled></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="4">
                  <el-form-item size="mini" label="标准金额">
                    <el-input v-model="currentPeople.quota" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item size="mini" label="收费状态">
                    <el-input :class="[currentPeople.chargeflag == 1 ? 'is_red' : '']" v-model="currentPeople.chargeflagcn" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item size="mini" label="费用">
                    <el-input v-model="currentPeople.price" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                ...
                <el-col :span="8">
                  <el-form-item size="mini" label="团检名称">
                    <el-input v-model="currentPeople.company" disabled></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
            </el-form>
      ...
      <el-row class="content_box">
        <el-col :span="5" class="personnel_box">
          <div class="pers_table_box">
            <div class="title">
              <div class="text">体检记录</div>
              <el-tag size="small">{{ persDataScreen.length || 0 }}</el-tag>
              <el-button style="margin-left: 8px" type="primary" size="mini" @click="handleChangePersChoose('pre')">上一人</el-button>
              <el-button type="primary" size="mini" @click="handleChangePersChoose('next')">下一人</el-button>
            </div>
            <el-date-picker style="width: 100%; margin: 3px 0 4px 0" v-model="screenData" type="daterange" range-separator="-" size="mini" start-placeholder="开始日期" end-placeholder="结束日期">
            </el-date-picker>
            <EasyTable :loading="loading" class="pers_table" height="100%" ref="persDataTable" :data="persDataScreen" @row-click="handleChoosePers" :tableOptions="persOptions" :radio-config="{
                rowClick: true,
            ...
            <div class="check_body">
              <div class="check_left">
                <div class="radio_box">
                  ...
                  <el-button type="primary" class="overview" size="mini" plain @click="handleResetOverView" :disabled="pageStatus">生成综述</el-button>
                </div>
                <!-- 当前页操作控件 -->
                ...
                <el-scrollbar class="check_b">
                  ...
                  <div v-if="checkActive == 'describe'" class="dom1">
                    <el-input class="combinename_text" type="textarea" resize="none" :autosize="true" :disabled="pageStatus" v-model="conclusiontext"></el-input>
                    <!-- <div
                ...
                <div class="occupation" v-if="isoccupation">
                  <div class="check_group">
                    <el-radio-group :disabled="pageStatus" v-model="checkRadio">
                      <el-radio v-for="(item, index) in occupationChecks" :key="index" :label="item.code">{{ item.name }}</el-radio>
                    </el-radio-group>
                    <el-checkbox :disabled="pageStatus" v-model="occupationSelects.selected">{{
              ...
              <div class="check_right">
                ...
                <div :class="[
                  ...
                  <div class="handle_btn_group">
                    <div class="handle_btn" @click="pageStatus != true && handleSelectAll()">
                ...
                <el-scrollbar class="check_b">
                  ...
                  <div v-for="(item, index) in worditems" :key="index">
                    ...
                    <el-checkbox-group v-if="
                        ...
                        activeName == 'jkjy'
                      " class="dom1 item_drag" v-model="checkAdvise1" :disabled="pageStatus">
                  ...
                  <!-- 饮食建议文本域 ysjy -->
                  <el-input v-if="activeName == 'ysjy' && dietadviceText != ''" class="ysjy" type="textarea" resize="none" v-model="dietadviceText" :disabled="pageStatus"></el-input>
                  <!-- 运动建议文本域 ydjy -->
                  <el-input v-if="activeName == 'ydjy' && sportsadviceText != ''" class="ydjy" type="textarea" resize="none" v-model="sportsadviceText" :disabled="pageStatus"></el-input>
                  <!-- 健康知识文本域 jkzs -->
                  <el-input v-if="activeName == 'jkzs' && healthknowledgeText != ''" class="jkzs" type="textarea" resize="none" v-model="healthknowledgeText" :disabled="pageStatus"></el-input>
                  <!-- 历史对比 dom2 contrast   -->
                  <div v-if="checkActive == 'contrast'" class="dom2">
            ...
            <div class="check_form">
              <el-form ref="form" :disabled="pageStatus || currentPeople.updatestatus == 0" :model="currentPeople" label-width="80px">
                ...
                <el-form-item size="mini" label="总检时间">
                  <el-date-picker v-model="currentPeople.inputdate" value-format="yyyy-MM-dd" type="date">
                  </el-date-picker>
                </el-form-item>
                ...
                <el-form-item size="mini" label="审核时间">
                  <el-date-picker v-model="currentPeople.checkdate" value-format="yyyy-MM-dd hh:mm:ss" type="date">
                  </el-date-picker>
                </el-form-item>
                <el-form-item size="mini" label="状态">
                  <el-input v-model="currentPeople.statuscn" disabled></el-input>
    ...
    <!-- 健康建议拖拽弹框 -->
    <el-dialog title="健康建议调整" class="summaryDia" top="5vh" :visible.sync="showMoveConclusion" width="1000px" :close-on-click-modal="false" :close-on-press-escape="false" :show-close="false" @open="handleOpenMoveConclusion">
      <div class="handle_btn_group">
      ...
      <div class="word_box">
        <el-input class="combinename_text" type="textarea" resize="none" disabled :autosize="true" v-model="conclusiontext"></el-input>
        <EasyTable :loading="loading" v-if="worditems[0]" height="100%" class="table_100 move_conclusion_t" style="height: 400px" :data="worditems[0].wordname" :tableOptions="moveConclusionOptions" @selected-change="handleSelectMoveDia" :checkbox-config="{ fetch: true, rowClick: true }" :border="false" :header-cell-style="handleReturnStyle" :row-class-name="handleTableRowClassName" :row-style="{ height: '60px' }" :cell-style="{ padding: '0px' }" row-key="uniqueid" />
      </div>
    ...
    <el-dialog class="dialog-mini history_pson" width="55%" height="100%" top="10%" :close-on-click-modal="false" title="历史体检信息" :visible.sync="historyShow" @close="handleCloseHistory">
      <div class="table_box">
        <EasyTable class="table_item" height="600px" row-id="groupid" :data="historySelectData" :tableOptions="historySelectOptions" :radio-config="{ fetch: true, rowClick: true }" @row-dblclick="handleHistoryCheck" :border="false" :header-cell-style="handleReturnStyle" :row-class-name="handleTableRowClassName" :row-style="{ height: '32px' }" :cell-style="{ padding: '0' }" />
      </div>
      <div style="text-align: center; margin-top: 15px">
    ...
    <!-- 查看组合详情数据弹框 -->
    <el-dialog title="检查结果" class="comb_dialog" :visible.sync="dialogVisible" width="70%">
...
export default {
  ...
  computed: {
    ...
    persDataScreen() {
      const search = this.screenData;
      // 进入筛选
      if (search && search.length == 2) {
        return this.persData.filter((data) => {
          if (data.regdate) {
            let condition1 = new Date(search[0]).getTime();
            let condition2 = new Date(search[1]).getTime();
            let returnData = new Date(data.regdate).getTime();
  ...
  methods: {
    ...
    // 上一人下一人回调
    handleChangePersChoose(flag) {
      if (!this.choosePers) {
        this.$message.warning("请先选中人员");
        return;
      }
      getNextRegid({ currentregid: this.choosePers.regid, tp: flag }).then(
        (res) => {
          if (!res.result) return;
          this.handleGetTotalCheck(res.result.regid);
        }
      );
      // let index = this.persDataScreen.findIndex((k) => {
      //   return k.regid == this.choosePers.regid;
      // });
      // if (index < 0) return;
      // if (flag == "prev") {
      //   if (index == 0) return;
      //   this.handleChoosePers(this.persDataScreen[index - 1]);
      //   this.$refs.persDataTable.$refs.easyTable.setCurrentRow(
      //     this.persDataScreen[index - 1]
      //   );
      // } else {
      //   if (index == this.persDataScreen.length - 1) return;
      //   this.handleChoosePers(this.persDataScreen[index + 1]);
      //   this.$refs.persDataTable.$refs.easyTable.setCurrentRow(
      //     this.persDataScreen[index + 1]
      //   );
    ...
    // 全选健康建议回调
    handleSelectAll() {
      if (this.worditems.length == 0) return;
      if (this.checkAdvise1.length === this.worditems[0].wordname.length) {
        this.checkAdvise1 = [];
      } else {
        this.checkAdvise1 = this.worditems[0].wordname;
      }
      console.log(this.checkAdvise1, "this.checkAdvise1");
    ...
    handleGetRegisterInfo() {
      ...
      getRegisterInfo(data).then((res) => {
        if (!res.result) return;
        this.persData = res.result.map((k) => {
          k.regdate;
          return {
            ...k,
            regdate: k.regdate.split(" ")[0],
          };
        });
        let flag = res.result.filter((k) => {
          return k.regid == this.currentPeople.regid;
        })[0];
        flag && (this.choosePers = flag);
      });
    },
    // 获取今天日期
    handleGetToday() {
    ...
    handleWordMerge() {
      ...
      // console.log(this.worditems[0], "this.worditems[0]");
      // console.log(this.checkAdvise1, "this.checkAdvise1");
      // console.log(this.checkAdvise1[0], "this.checkAdvise1[0]");
      // return;
      // 循环合并数据
      let temp = {
        regid: this.worditems[0].regid,
        cluid: this.worditems[0].cluid,
        combinecode: this.worditems[0].combinecode,
        combinename: this.worditems[0].combinename,
        wordname: "",
    ...
    // 获取总检结果回调
    handleGetTotalCheck(regid) {
      let whereitems = [
        {
          key: this.conditionCode,
          value: regid || this.checkupWork.trim(),
        },
      ];
      if (this.currentPeople.regid) {
        whereitems.push({
    ...
    hadnleOnBtnClicked(domId) {
      ...
      switch (domId) {
        ...
        case "btnEdit": // 新增
          ...
          //   this.$message.warning("当前人员已审核不允许修改,请取消审核再修改!");
          //   return;
          // }
