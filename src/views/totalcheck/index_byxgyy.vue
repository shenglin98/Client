  ...
  <div class="total_check">
        ...
        <el-col :span="19">
          <div class="body_box">
              ...
              <div class="check_right">
                ...
                >
                  ...
                  <div class="handle_btn_group">
                    <div
                      class="handle_btn"
                      @click="pageStatus != true && handleMoveConclusion()"
                    >
                      <el-tooltip
                        class="item"
                        effect="dark"
                    ...
                    <div
                      class="handle_btn"
                      @click="pageStatus != true && handleAddConclusion()"
                    >
                      <el-tooltip
                        class="item"
                        effect="dark"
                    ...
                    <div
                      class="handle_btn"
                      @click="pageStatus != true && handleDelWordItems()"
                    >
                      <el-tooltip
                        class="item"
                        effect="dark"
                    ...
                    <div
                      class="handle_btn"
                      @click="pageStatus != true && handleMoveTopping()"
                    >
                      <el-tooltip
                        class="item"
                        effect="dark"
                    ...
                    <div
                      class="handle_btn"
                      @click="pageStatus != true && handleMoveTop()"
                    >
                      <el-tooltip
                        class="item"
                        effect="dark"
                    ...
                    <div
                      class="handle_btn"
                      @click="pageStatus != true && handleMoveBottom()"
                    >
                      <el-tooltip
                        class="item"
                        effect="dark"
                    ...
                    <div
                      class="handle_btn"
                      @click="pageStatus != true && handleWordMerge()"
                    >
                      <el-tooltip
                        class="item"
                        effect="dark"
            ...
            <div class="check_form">
              <el-form
                ref="form"
                :disabled="pageStatus || currentPeople.updatestatus == 0"
                :model="currentPeople"
                label-width="80px"
              >
    ...
    >
      ...
      <el-tree
        ...
        @check-change="handleSelectMoveTree"
      >
        <span class="custom-tree-node" slot-scope="{ node, data }">
        ...
        case "btnReport": // 报告书
          this.$refs.popoverRefIdc.forEach((d) => {
            if (d.$children[0].$el.innerText == "报告书") {
              ...
              } else if (this.currentPeople.meccode == 10005) {
                repname = `${indexP}F第一健康报告书`;
              } else if (this.currentPeople.meccode == 10006) {
    ...
    handleAddConcConfirm() {
      if (!this.chooseConclusion) {
        ...
        if (this.worditems.length == 0) {
          ...
          flag && this.worditems[0].wordname.unshift(...tempArr);
        }
        if (flag == false) {
