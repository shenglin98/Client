              ...
              <el-row>
                ...
                <el-col :span="4">
                  <el-form-item size="mini" label="录入状态">
                    <el-input v-model="currentPeople.inputstatuscn"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
              ...
              <el-row>
                ...
                <el-col :span="4">
                  <el-form-item size="mini" label="收费状态">
                    <el-input :class="[currentPeople.chargeflag == 1 ? 'is_red' : '']" v-model="currentPeople.chargeflagcn"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                ...
                <el-col :span="4">
                  <el-form-item size="mini" label="状态">
                    <el-input v-model="currentPeople.statuscn"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
      ...
      <el-row class="content_box">
        <el-col :span="5" class="personnel_box">
          <div class="pers_table_box">
            ...
            <EasyTable :loading="loading" class="pers_table" height="100%" :data="persDataScreen" @row-click="handleChoosePers" :tableOptions="persOptions" :radio-config="{
                rowClick: true,
              ...
              <div class="check_left">
                <div class="radio_box">
                  ...
                  <el-radio-group v-model="checkActive" @change="handleTabsChange" size="mini">
                    ...
                    <el-radio-button label="employment">入职综述</el-radio-button>
                  </el-radio-group>
                ...
                <el-scrollbar class="check_b">
                  ...
                  <!-- 入职综述 dom6 employment -->
                  <div v-if="checkActive == 'employment'" class="dom6">
                    <div class="dom6_box">
                      <div class="dom6_title">X光结论：</div>
                      <el-input class="combinename_text" type="textarea" resize="none" :autosize="true" v-model="entryJobXrayconclusion"></el-input>
                    </div>
                    <div class="dom6_box">
                      <div class="dom6_title">体检结论：</div>
                      <el-input class="combinename_text" type="textarea" resize="none" :autosize="true" v-model="entryJobconclusion"></el-input>
                    </div>
                  </div>
                </el-scrollbar>
                <!-- 职业性评价 -->
              ...
              <div class="check_right">
                ...
                <div :class="[
                  ...
                  <div class="handle_btn_group">
                    <div class="handle_btn" @click="handleSelectAll">
...
export default {
  ...
  data() {
    return {
      ...
      tinymceFlag1: 1,
      tinymceFlag2: 1,
      checkActive: "describe", // 左侧当前选中标签页 describe  contrast  depart  totalCheck  archives employment
      ...
      conclusiontext: "", // 综述文字
      entryJobXrayconclusion: "", // x光结论
      entryJobconclusion: "", // 体检结论
  ...
  methods: {
    ...
    handleSelectPrintDia() {
      ...
      this.$refs.popoverRefIdc.forEach((d) => {
        if (d.$children[0].$el.innerText == "报告书") {
          ...
          let repname = "";
          if (this.currentPeople.checktype == "12") {
            repname = `${indexP}专项报告书`;
          } else {
    ...
    handleSetTotalCheckSave() {
      ...
      if (occupationitems.length == 0) {
        data = {
          ...
          entryJobXrayconclusion: this.entryJobXrayconclusion,
          entryJobconclusion: this.entryJobconclusion,
          worditems,
    ...
    handleGetTotalCheck() {
      ...
      getTotalCheckQyzyy({ whereitems }).then((res) => {
        ...
        this.entryJobXrayconclusion = data.entryJobXrayconclusion;
        this.entryJobconclusion = data.entryJobconclusion;
        if (data.status < 3) {
