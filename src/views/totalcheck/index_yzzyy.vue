          ...
          <el-col :span="19" class="form_box">
            <el-form ref="form" :model="currentPeople" label-width="80px">
              ...
              <el-row>
                ...
                <el-col :span="4">
                  <el-form-item size="mini" label="结论标志">
                    <el-input v-model="currentPeople.conclusionflagdes"></el-input>
                    <!-- <el-select
                      v-model="currentPeople.conclusionflag"
                      size="mini"
                    >
          ...
          this.$refs.popoverRefIdc.forEach((d) => {
            if (d.$children[0].$el.innerText == "报告书") {
              ...
              if (this.currentPeople.checktype == 1) {
                ...
                repname = `${indexP}F报告书`;
                // repname = `${indexP}体格检查表`;
              } else if (this.currentPeople.checktype == 3) {
                repname = `${indexP}民兵体格检查表`;
              } else if (this.currentPeople.checktype == 4) {
                repname = `${indexP}教师体格检查表`;
              } else if (this.currentPeople.checktype == 5) {
                repname = `${indexP}F团体报告书`;
              } else if (this.currentPeople.checktype == 6) {
                repname = `${indexP}体格检查表`;
              } else if (this.currentPeople.checktype == 7) {
                repname = `${indexP}乡村健康体检表`;
              } else if (this.currentPeople.checktype == 8) {
                repname = `${indexP}入学体检表`;
              } else if (this.currentPeople.checktype == 9) {
                repname = `${indexP}体格检查表`;
              } else if (this.currentPeople.checktype == 98) {
                repname = `${indexP}高中入学体格检查表`;
              } else {
    ...
    handleSetTotalCheckSave() {
      ...
      if (occupationitems.length == 0) {
        data = {
          ...
          // conclusionflag: this.currentPeople.conclusionflag,
          conclusionflagdes: this.currentPeople.conclusionflagdes,
          worditems,
