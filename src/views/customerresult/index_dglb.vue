  ...
  <div class="customer_result">
    ...
    <div class="pageReg" v-if="!showQuestionnaire">
      ...
      <div class="filter-container">
        ...
        <el-upload class="upload-demo" name="files" action="" accept=".xls,.xlsx" :show-file-list="false" :auto-upload="false" :on-change="handleChangeUploadBmi" :file-list="fileListBmi">
          <el-button type="primary" plain size="mini">身高体重导入</el-button>
        </el-upload>
      </div>
            ...
            <div class="summary">
              ...
              <div class="summary_content">
                ...
                <div class="summary-box" v-if="!imageInfoFlag">
                  <!-- 富文本 -->
                  <div class="tinymce_box" style="z-index: 1000;">
                    <!-- <vue-tinymce
                  ...
                  <el-row>
                    <el-col :span="8">
                      <el-form-item size="mini" label="检查医生">
                        <el-select :disabled="summaryForm.conclusionstatus == 1" v-model="summaryForm.doctorcode" filterable allow-create @change="handleChangeDoctor">
      ...
      <el-dialog title="录入结果模板" class="splitFlag_dialog" :visible.sync="splitFlag" width="50%" :close-on-click-modal="false" :show-close="false">
        <div class="splitFlag_content">
          <div class="splitFlag_item" v-for="item,index in splits" :key="index">
            ...
            <el-select style="width: 150px;" v-if="item.lableType == 2" v-model="item.content" size="mini" placeholder="请选择">
...
import {
  ...
  SplitContent,
  UpdatVerification,
  ImportCheckHeightData,
  ImportHeightDataSave,
...
export default {
  ...
  methods: {
    // 文件导入上传-Bmi
    handleChangeUploadBmi(file, fileList) {
      ...
      setFilesUpload(data).then((res1) => {
        ...
        if (fileObj) {
          ...
          // 检查文件
          ImportCheckHeightData({ fileId: fileObj.id })
            .then((res2) => {
              loading.close();
              ...
              if (isCheckEye && isCheckEye.length > 0) {
                this.$confirm(
                  ...
                  .then(() => {
                    ImportHeightDataSave({ fileId: fileObj.id }).then((res) => {
    ...
    hadnleOnBtnClicked(domId) {
      switch (domId) {
        ...
        case "btnConfirmVerification": // 核对确认
          ...
          this.handleUpdateVerification(1);
          break;
        case "btnCancelVerification": // 取消确认
          ...
          if (this.userInfo.usercode != this.personalForm.confirmdoctorcode) {
