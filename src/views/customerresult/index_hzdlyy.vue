    ...
    <div class="pageReg" v-if="!showQuestionnaire">
      ...
      <div class="subject">
        ...
        <div class="subject_right">
            ...
            <div class="summary">
              ...
              <div class="summary_content">
                <div class="summary_btn">
                  ...
                  <div class="entry_btn" v-if="
                      !chooseDepart ||
                      (chooseDepart && chooseDepart.viewgroup != '2')
                    ">
                  ...
                  <el-row>
                    ...
                    <el-col :span="8">
                      <el-form-item size="mini" label="录入时间">
                        <el-date-picker :disabled="summaryForm.conclusionstatus == 1" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" placeholder="录入时间" v-model="summaryForm.inputdate" style="width: 100%"></el-date-picker>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
          ...
          <div class="common_result">
            ...
            <div class="words_box" v-if="chooseDepart && chooseDepart.viewgroup == '2'">
              <div class="words_btn">
                <el-button type="primary" plain size="mini" icon="el-icon-plus" @click="handleAddConclusion">增加</el-button>
                <el-button type="primary" plain size="mini" icon="el-icon-delete" @click="handleDelConclusion">删除</el-button>
              </div>
              <div class="words_table">
                <EasyTable :loading="loading" class="entry_table" height="100%" :data="entryData" :tableOptions="entryOptions" :radio-config="{ rowClick: true }" @row-click="handleChooseEntry" :border="false" :header-cell-style="handleReturnStyle" :row-class-name="handleTableRowClassName" :row-style="{ height: '28px' }" :cell-style="{ padding: '0' }" />
              </div>
            </div>
            <div class="table_box_c" v-else>
      ...
      <el-dialog :show-close="false" :close-on-click-modal="false" class="historyAllResult_dai" :visible.sync="showHistoryAllResult" width="65%" title="检验维护窗口(注：此功能将直接修改检验数据，谨慎！)" @close="handleHistoryAllResultCancel">
        <div class="har_content">
          ...
          <div class="har_tablebox" style="display: flex;">
            <vxe-table style="width: calc(60% - 10px);margin-right: 10px;" class="people_table" ref="peopleTable" height="100%" border="inner" :loading="loading" highlight-hover-row highlight-current-row :header-cell-style="handleReturnStyle" :row-class-name="handleTableRowClassName" :data="historyAllResult" :checkbox-config="{ reserve: true, trigger: 'row' }" :sort-config="{ trigger: 'cell' }" :scroll-y="{ enabled: false }" @cell-click="handleChooseHistoryAll">
              ...
              <vxe-table-column field="sex" title="性别" width="80" sortable>
                <template slot-scope="scope">
                  <span>{{
                    scope.row.sex == 0
                      ? "未知"
              ...
              <!-- <vxe-table-column
                ...
                width="120"
              ></vxe-table-column> -->
              <vxe-table-column field="checkdate" title="检查时间" min-width="170"></vxe-table-column>
            </vxe-table>
            <EasyTable style="width: 40%;" :loading="loading" height="100%" class="table_100" :data="chooseHistoryAll && chooseHistoryAll.resultItems" :tableOptions="checkoutHistoryOptions" :radio-config="{ rowClick: true }" :row-style="rowstyle" @row-dblclick="handleCheckEcharts" :border="false" :header-cell-style="handleReturnStyle" :row-class-name="handleTableRowClassName" :cell-style="{ padding: '0' }" />
          </div>
        </div>
        <span slot="footer" class="dialog-footer">
