      ...
      <div class="messagebasic">
        ...
        <div class="content_r">
          <div class="content_r-in">
            ...
            >
              <div>
                <el-col :span="4" style="margin-right: 15px; height: 35px">
...
export default {
  ...
  methods: {
    ...
    handleGetDefaultConclusion() {
      ...
      getDefaultConclusion(data).then((res) => {
        ...
        if (
          ...
          this.chooseProjectArr.length == 1
        ) {
          this.conclusion = this.chooseProjectArr[0].result;
        } else {
    ...
    handleInputdom1(item) {
      ...
      }
      {
        ...
        if (k.itemcode == item.itemcode) {
          ...
          k.result = item.reslower;
          k.result = item.resupper;
        }
      }); */
      }
      for (let index = 0; index < this.chooseProjectArr.length; index++) {
        if (this.chooseProjectArr[index].itemcode == item.itemcode) {
          this.chooseProjectArr[index].result = item.result;
          this.chooseProjectArr[index].reslower = item.reslower;
          this.chooseProjectArr[index].resupper = item.resupper;
        }
      }
      this.handleGetConclusionDetail();
    },
    ...
    handleOnEditorFocus(data) {
      ...
      console.log(this.chooseInputItem, "this.chooseInputItem");
    ...
    hadnleOnBtnClicked(domId) {
      switch (domId) {
        ...
        case "btnKeep": // 保存
          if (!this.chooseDepart) return false;
          if (this.chooseDepart.items && this.chooseDepart.items.length > 0) {
            let flag = this.chooseDepart.items.filter((k) => {
              return k.result == "/" || !k.result;
            })[0];
            if (flag) {
              this.$confirm("有项目结果为空，是否保存?", "提示", {
                confirmButtonText: "是",
                cancelButtonText: "否",
                type: "warning",
              })
          ...
          console.log(this.chooseDepart, "this.chooseDepart");
          return;
          this.handleSubmitPage();
          break;
