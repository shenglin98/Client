          ...
          <div class="inspect_result">
            ...
            <div class="summary">
              ...
              <div class="summary_content">
                <div class="summary_btn">
                  <div class="fruit_btn">
                    ...
                    <el-link class="nowrap" type="primary" :disabled="this.showBigMask" v-if="fruit == 'specialistadvice'" @click="handleAddSpecialis">新增建议</el-link>
                  ...
                  <div class="entry_btn">
                    <el-button type="primary" plain size="mini" icon="el-icon-plus" :disabled="this.showBigMask" @click="handleAddConclusion">增加</el-button>
                    <el-button type="primary" plain size="mini" :disabled="this.showBigMask" icon="el-icon-delete" @click="handleDelConclusion">删除</el-button>
                  </div>
                </div>
                <div class="summary-box" v-if="!imageInfoFlag">
                  ...
                  <div class="tinymce_box">
                    ...
                    <vue-tinymce
                      ...
                      :setting="setting"
                    /> -->
                    <el-input class="conc_text" :rows="5" :disabled="this.showBigMask" type="textarea" resize="none" v-if="fruit == 'conclusion'" v-model="conclusion"></el-input>
                    <el-input class="conc_text" :rows="5" :disabled="this.showBigMask" type="textarea" resize="none" v-if="fruit == 'specialistadvice'" v-model="specialistadvice"></el-input>
                  </div>
                  <!-- 表格结论词 -->
              ...
              <div class="summary_form">
                <el-form ref="form" :disabled="this.showBigMask" :model="summaryForm" label-width="80px">
                  <el-row>
                    <el-col :span="8">
...
export default {
    ...
    checkoutOptions() {
      return [
        ...
        },
        {
          ...
          render: (h, data) => {
            if (data.resexp !== "") {
              let tempresexp = data.resexp.replaceAll("\r\n", "<br/>");
              return (
                <div
                  style="text-align:left"
                  domPropsInnerHTML={tempresexp || ""}
                ></div>
              );
            } else {
              return (
  ...
  mounted() {
    ...
    userlogin.GetMyOrgs().then((response) => {
      ...
      this.authStrategyFlag = this.loginUserInfo.authStrategy.toLowerCase();
    });
  ...
  methods: {
    ...
    handleJumpPanorama() {
      ...
      if (!userInfo) return;
      let jumpLink = `http://10.0.3.8:8082/CCD/new/index_pc.html?hideSearch=false&isMenZenFilter=false&deptId=NY1306&emrUser=${userInfo.usercode}&hospitalizeNo=${this.personalForm.regid}&urlFrom=TJXT`;
          ...
          if (!res.result) {
            ...
            if (this.chooseDepart) {
              ...
              if (nextClick.length > 0) {
                ...
                this.$nextTick(() => {
                  if (data.departitems.length == 0) return;
      ...
      switch (domId) {
        ...
        case "btnEdit": // 编辑
          if (
            ...
            this.$message.warning("弃检项目不允许录入结果!");
            return;
          }
          this.showBigMask = false;
          if (this.currentUser) {
