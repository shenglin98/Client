      ...
      <div class="messagebasic">
        ...
        <div class="content_l">
          <div class="head">
            ...
            <!-- 单位条件 -->
            <el-select
              style="margin-left: 6px; min-width: 190px"
              filterable
              clearable
              size="mini"
          ...
          <div class="unitPeopleList">
            <div class="upl_table">
              <EasyTable
                ...
                height="100%"
                :data="persData"
                @row-click="handleChoosePers"
                :tableOptions="persOptions"
                :radio-config="{
                  rowClick: true,
                }"
                :border="false"
          ...
          <div class="common_result">
            ...
            <div class="table_box_c">
              <el-radio-group
                ...
                style="padding: 10px"
              >
                <el-radio-button label="wordsTable">结论词</el-radio-button>
                <el-radio-button label="commonResult">常见结果</el-radio-button>
                <el-radio-button label="historyResult"
                  >历史结果</el-radio-button
                >
                <el-radio-button label="allInspections"
                  >所有检查</el-radio-button
                >
                <el-radio-button label="healthRecords"
                  >健康档案</el-radio-button
                >
              </el-radio-group>
              <!-- 表格展示数据 -->
              <div class="table_box">
                <div class="words_box" v-if="showTableFlag == 'wordsTable'">
                  <div class="words_btn">
                    <el-button
                      type="primary"
                      plain
                ...
                <div
                  class="history_box"
                  v-if="showTableFlag == 'historyResult'"
                >
...
export default {
  ...
  data() {
    return {
      ...
      healthDtData: [], // 健康详情数据
      showTableFlag: "wordsTable", // 显示表格信息-- wordsTable commonResult historyResult allInspections  healthRecords
  ...
  methods: {
    ...
    handleGetDepartCheck(regid) {
      ...
      getDepartCheck({
        code: regid ? regid : this.checkupWork.trim(),
        whereitems,
      })
        .then((res) => {
