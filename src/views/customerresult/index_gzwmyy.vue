                  ...
                  <el-row>
                    <el-col :span="8">
                      <el-form-item size="mini" label="检查医生">
                        <el-select clearable filterable :disabled="summaryForm.conclusionstatus == 1" v-model="summaryForm.doctorcode" @change="handleChangeDoctor">
            ...
            .then((res2) => {
              ...
              if (isCheckEye && isCheckEye.length > 0) {
                this.$confirm(
                  ...
                  .then(() => {
                    ImportEyeDataSaveForGZWMKFYY({ fileId: fileObj.id }).then(
                      (res) => {
