  ...
  <div class="customer_result">
    ...
    <div class="triage_ejectbox" v-drag v-if="showTriageDia">
      ...
      <div class="top_btn">
        ...
        <el-button size="small" type="primary" @click="showTriageDia = false">关闭</el-button>
      </div>
      ...
      <div class="eject_table_box">
        ...
        <div class="ejecttable_box">
          <vxe-table ref="ejecttable" class="ejecttable" height="auto" :loading="ejectLoading" highlight-hover-row :data="ejectStatus == '待检' ? queuePaiDuiList : completeList" :checkbox-config="{ trigger: 'row' }" :header-cell-style="handleReturnStyle" :row-class-name="handleTableRowClassName">
            <vxe-table-column field="queueno" title="排队号" show-header-overflow show-overflow="title" width="70px" show-footer-overflow></vxe-table-column>
            ...
            <vxe-table-column field="regid" title="体检号" show-header-overflow show-overflow="title" show-footer-overflow></vxe-table-column>
    ...
    <!-- 点击配置科室弹框 -->
    <el-dialog title="" class="tedepart_dia" :visible.sync="showDepart" width="30%" :show-close="false" :close-on-click-modal="false">
      <span>
        <div class="tetop">
          <div>检索</div>
    ...
    <div class="pageReg" v-if="!showQuestionnaire">
          ...
          <div class="content_r-in">
            <el-form ref="form" :model="personalForm" label-width="70px">
              <el-row>
                ...
                <el-col :span="5">
                  <el-form-item size="mini" class="age" label-width="80px" label="年龄">
                    <el-input type="text" class="age_num" disabled v-model="personalForm.age"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="6">
              ...
              <el-row>
                ...
                <el-col :span="4">
                  <el-form-item class="group_inspection" size="mini" label="费用" label-width="80px">
              ...
              <el-row>
                ...
                <el-col :span="6">
                  <el-form-item class="group_inspection" size="mini" label="门诊号" label-width="80px">
                    <el-input disabled v-model="personalForm.hiscode"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="6">
                  <el-form-item class="apply_inspection" size="mini" label="申请号" label-width="80px">
                    <el-input v-if="chooseDepart" v-model="chooseDepart.applynomedical"></el-input>
                    <el-input v-else disabled v-model="personalForm.applynomedical"></el-input>
                    <el-button :disabled="!personalForm.regid" type="primary" size="mini" @click="handleChangeApplyno">修改</el-button>
                  </el-form-item>
                </el-col>
              </el-row>
            </el-form>
        ...
        <div class="subject_left">
          <div class="department content_right">
            ...
            <div v-if="departitems.length > 0">
              <el-tree ref="rightsTree" style="overflow-x: hidden" :data="departitems" node-key="id" :props="defaultProps" :default-expand-all="true" :default-checked-keys="defaultChecked" @node-click="handleNodeClick">
                <span class="custom-tree-node" style="
                  ...
                  <img v-if="data.isconclusion && data.conclusionstatus == 0 && data.ismustinputall" :src="substatus0" :draggable="false" class="rightstreeimg" />
                  ...
                  <span class="is_black" :class="[
                      data.isconclusion
                        ? data.conclusionstatus == 0 && data.ismustinputall
                          ? 'is_blue'
              ...
              <div class="summary_content">
                ...
                <div class="summary-box" v-if="!imageInfoFlag">
                  ...
                  <div class="tinymce_box">
                    ...
                    <el-input class="conc_text" :rows="5" type="textarea" resize="none" v-if="fruit == 'specialistadvice'" v-model="specialistadvice"></el-input>
                  </div>
                  <!-- 表格结论词 -->
                ...
                <div class="summary-box" v-else>
                  <el-upload class="photo_wall" name="files" action list-type="picture-card" accept=".jpg,.jpeg,.png" :file-list="fileList" :auto-upload="false" :on-change="handleOnPpload">
                  ...
                  <el-row>
                    <el-col :span="8">
                      <el-form-item size="mini" label="检查医生">
                        <el-select :disabled="summaryForm.conclusionstatus == 1" v-model="summaryForm.doctorcode" @change="handleChangeDoctor">
      ...
      <!-- 保存小结提示弹框 -->
      <el-dialog title="小结" class="summaryDia" :visible.sync="showSummaryDia" width="35%" :close-on-click-modal="false" :close-on-press-escape="false" :show-close="false">
