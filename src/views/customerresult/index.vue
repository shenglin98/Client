          ...
          <div class="content_r-in">
            ...
            >
              <div>
                ...
                <el-col :span="6" style="margin-right: 15px; height: 35px">
                  <el-form-item
                    size="mini"
                    class="age"
                    label-width="80px"
          ...
          <div class="inspect_result">
            ...
            <div class="project">
              ...
              <div
                class="mask_big"
                :class="[
                  chooseDepart && chooseDepart.viewgroup != '3'
                    ? 'mask_big_w'
                    : '',
                ]"
                v-if="showBigMask"
                  ...
                  <div class="fruit_btn">
                    ...
                    <el-button-group class="nowrap">
                      ...
                      <el-button
                        ...
                        plain
                        type="primary"
                        @click="handleGetConclusionDetail"
                        >生成小结</el-button
                      >
                    </el-button-group>
                  </div>
            ...
            return (
              <div style="display: flex;">
                ...
                <el-input
                  ...
                  size="mini"
                  nativeOnkeyup={(e) =>
                    e.keyCode == 13 && this.handleInputdom1(data)
                  }
  ...
  methods: {
    ...
    handleGetGenerateConclusion() {
      ...
      getGenerateConclusion(data).then((res) => {
        ...
        // this.specialistadvice = res.result.specialistadvice;
        this.conclusion = res.result.conclusion;
        if (!res.result.worditems) return false;
