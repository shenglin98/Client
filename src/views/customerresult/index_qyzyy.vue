                  ...
                  <el-row>
                    <el-col :span="8">
                      <el-form-item size="mini" label="检查医生">
                        <el-select filterable allow-create :disabled="summaryForm.conclusionstatus == 1" v-model="summaryForm.doctorcode" @change="handleChangeDoctor">
...
export default {
  ...
  methods: {
    ...
    handleOnEditorInput(data) {
      if (this.chooseDepart.viewgroup == 3 && data.conclusionflag == 1) {
        this.handleInputdom1(data);
      } else {
        if (
          this.conclusion == "" ||
