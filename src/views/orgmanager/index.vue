  ...
  <div class="flex-column">
    ...
    <div class="app-container flex-item">
      ...
      <el-dialog class="dialog-mini user-dialog" v-el-drag-dialog :title="'分配用户'" :visible.sync="roleUsers.dialogUserResource">
        <selectUsersCom ref="selectUser" v-if="roleUsers.dialogUserResource" :orgId="multipleSelection[0].id" :hiddenFooter="true" :loginKey="'loginUser'" :users.sync="assignedUserIds" :userNames="roleUsers.rowIndex > -1 && roleUsers.list[roleUsers.rowIndex].map(u=>u.name||u.account).join(',')">
        </selectUsersCom>
    ...
    loadRoleUsers() {
      ...
      apiUsers
        ...
        .then((response) => {
          ...
          _this.assignedUserIds = _this.roleUsers.list[
