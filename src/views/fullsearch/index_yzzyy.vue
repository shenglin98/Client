            ...
            if (d.$children[0].$el.innerText == "报告书") {
              this.downloadList.forEach((printItem) => {
                let indexP =
                  d.$children[0].$attrs["data-remark"].split("、")[0] + "、";
                let repname = "";
                if (printItem.checktype == 1) {
                  repname = `${indexP}F报告书`;
                } else if (printItem.checktype == 2) {
                  repname = `${indexP}F报告书`;
                  // repname = `${indexP}体格检查表`;
                } else if (printItem.checktype == 3) {
                  repname = `${indexP}民兵体格检查表`;
                } else if (printItem.checktype == 4) {
                  repname = `${indexP}教师体格检查表`;
                } else if (printItem.checktype == 5) {
                  repname = `${indexP}F团体报告书`;
                } else if (printItem.checktype == 6) {
                  repname = `${indexP}体格检查表`;
                } else if (printItem.checktype == 7) {
                  repname = `${indexP}乡村健康体检表`;
                } else if (printItem.checktype == 8) {
                  repname = `${indexP}入学体检表`;
                } else if (printItem.checktype == 9) {
                  repname = `${indexP}体格检查表`;
                } else if (printItem.checktype == 98) {
        ...
        if (d.$children[0].$el.innerText == "报告书") {
          ...
          for (let i = 0; i < this.downloadList.length; i++) {
            if (this.downloadList[i].checktype == 1) {
              repname = `${indexP}F报告书`;
            } else if (this.downloadList[i].checktype == 2) {
              repname = `${indexP}F报告书`;
              // repname = `${indexP}体格检查表`;
            } else if (this.downloadList[i].checktype == 3) {
              repname = `${indexP}民兵体格检查表`;
            } else if (this.downloadList[i].checktype == 4) {
              repname = `${indexP}教师体格检查表`;
            } else if (this.downloadList[i].checktype == 5) {
              repname = `${indexP}F团体报告书`;
            } else if (this.downloadList[i].checktype == 6) {
              repname = `${indexP}体格检查表`;
            } else if (this.downloadList[i].checktype == 7) {
              repname = `${indexP}乡村健康体检表`;
            } else if (this.downloadList[i].checktype == 8) {
              repname = `${indexP}入学体检表`;
            } else if (this.downloadList[i].checktype == 9) {
              repname = `${indexP}体格检查表`;
            } else if (this.downloadList[i].checktype == 98) {
              repname = `${indexP}高中入学体格检查表`;
            } else {
              repname = d.$children[0].$attrs["data-remark"];
            }
            await this.handlePrintReportAsync(repname, this.downloadList[i]);
          }
        }
      });
    },
